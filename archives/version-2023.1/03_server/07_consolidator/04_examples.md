...
The example below comes from the Consolidator exercise in our [tutorial](../../../getting-started/developer-training/training-content-day4/#consolidators). It has a single consolidator, called `CONSOLIDATE_POSITIONS`.
