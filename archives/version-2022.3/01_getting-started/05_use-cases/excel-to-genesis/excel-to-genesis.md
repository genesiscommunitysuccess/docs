...
The conversion script will turn the Excel functions in the workbook into Kotlin code for use by your application. The most [common Excel functions](/server/integration/excel-to-genesis/excel-functions) are all covered.
