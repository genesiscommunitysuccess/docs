  ...
  constructor(scope: Construct, id: string, stackProps: StackProperties) {
    ...
    const amplifyApp = new amplify.App(this, stackOptions.stackPrefix + 'DocsAmplifyApp', {
      ...
      sourceCodeProvider: new amplify.GitHubSourceCodeProvider({
        ...
        owner: 'genesislcap',
        repository: 'docs',
        // PAT is generated by using NickPayne account, github user name: makeusabrew
        // As PAT is associated with individual user, if user access to docs repo is revoked then token will stop working. We need to generate new one with Admin user
