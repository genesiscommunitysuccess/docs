...
id: sso-saml
keywords: [SAML, server, access control, SSO, authentication]
tags:
  - SAML
  - server
  - access control
...
This workflow is described in more detail in the section on [Front-to-back flow](../../../server/access-control/sso-saml/#front-to-back-flow).
