...
You can use the [positions app tutorial repo](https://github.com/genesiscommunitysuccess/alpha/tree/Complete_positions_app/server/jvm) as a reference point for the event handlers. 
