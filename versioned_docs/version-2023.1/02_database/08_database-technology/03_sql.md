...
| `DbSqlConnectionPoolSize`  | The maximum number of SQL connections to be held by the SQL connection pool of each JVM process which connects to the database                                                                                                                                                                                                                                           |  
