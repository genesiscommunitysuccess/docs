...
Remote databases do not work with Data Pipelines by default; they require some set-up/configuration to enable Change Data Capture functionality. Find details on set-up [here](../../../../operations/pipeline-setup/)
