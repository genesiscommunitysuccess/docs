...
The `API_HOST` should be set correctly by default from the `genx` CLI, but if you are having issues see [this section](../../../getting-started/quick-start/run-the-application).
