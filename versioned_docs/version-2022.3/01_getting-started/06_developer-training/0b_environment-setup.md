...
To follow the instructions below, select **External User** if you are a Genesis customers or partner, or **Internal User** if you are a Genesis employee with an internal Genesis account.
:::
