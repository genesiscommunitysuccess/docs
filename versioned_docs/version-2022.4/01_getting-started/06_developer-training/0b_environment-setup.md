...
To follow the instructions below, select **External User** if you are a Genesis customer or partners, or **Internal User**  if you are a Genesis employee) with an internal Genesis account.
:::
