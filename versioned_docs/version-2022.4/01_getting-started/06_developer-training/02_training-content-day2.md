...
4. Add queries to the Data Server. These must point to the new tables in the **alpha-dataserver.kts** file. Besides, add INSTRUMENT_ID field in the `ALL_PRICES` query as this field is not null.
