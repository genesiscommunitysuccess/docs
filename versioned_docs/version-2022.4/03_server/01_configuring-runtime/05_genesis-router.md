...
For more information on the attributes that can be set in this file, go to our page on [service definitions](../../../server/configuring-runtime/service-definitions/).
