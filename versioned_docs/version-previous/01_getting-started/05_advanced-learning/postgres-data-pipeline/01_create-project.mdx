...
Use `genx` to create new blank project following the instructions [here](/getting-started/quick-start/new-project-using-genx/create-a-new-project/). For the rest of the tutorial, **datapipeline-trades** will be used for the project name, but feel free to choose any name you like.

## The Genesis data model

Now following the steps [here](../../../../getting-started/quick-start/new-project-using-genx/define-the-data-model/) we'll define our data model. Don't forget that the project name is `datapipeline-trades` (or the one you chose). The model for the application is the following:
