...
- users with a working knowledge of [Camel](../../../01_getting-started/07_glossary/01_glossary.mdx#camel-apache-camel)
  :::
...
Here is an [example of the data](./03_example-source-data.mdx) you can download from the Bloomberg Issuance feed.
