...
5. Create INSERT, MODIFY and DELETE (CRUD) events for all entities, using Event Handlers. When you finish, remember to [build](../../../getting-started/developer-training/training-content-day1/).
...
- [Build](../../../getting-started/developer-training/training-content-day1/). You can test by using Postman or Console (see more details in the next section) to insert:
  - a new counterparty
  - a new instrument
  - a new trade
