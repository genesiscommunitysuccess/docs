...
To get started, you need to access the [Genesis Create](https://create.genesis.global). This is a tool provided by Genesis, which enables you to run a full-stack application with a few clicks.
