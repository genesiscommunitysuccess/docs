...
Views are the Genesis way of retrieving data across multiple tables, similar to an SQL query with joins. Unlike [tables](../../../database/data-types/table-entities/), views do not have any data of their own, but present a view based on the data in one or more tables. 
