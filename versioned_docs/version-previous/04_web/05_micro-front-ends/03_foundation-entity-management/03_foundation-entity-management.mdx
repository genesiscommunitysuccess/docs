...
:::info
Profile Management is a concrete use case of the [Entity Management](/web/micro-front-ends/foundation-entity-management/) micro front-end, which is provided as part of `foundation-ui`.
:::
