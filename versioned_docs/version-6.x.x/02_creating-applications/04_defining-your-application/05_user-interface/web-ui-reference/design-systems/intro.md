...
When you generate a design system using [CLI](/creating-applications/creating-a-new-project/web-project-setup/) it will automatically extend a base design system that we have provided.
