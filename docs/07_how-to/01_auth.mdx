...
## Access to data and the ability to change it
GENESIS_AUTH is the component that ensures that only permitted users can **view** and **update (create, edit, delete)** data in your application.
...
Broadly speaking, you can insert these permissioning statements on the back end at three levels:
...
| User B | **view** the grid of trades, and **create** and **edit** trades              | **delete** trades  trades                                                   |
| User C | **view** the grid of trades, and **create**, **edit** and *delete** trades  |                                                                                            |
| User D |                                                                                                   | **view** the grid of trades, or any buttons  to  **create**, **edit** or **delete** trades**view**, **create**, **edit** or **delete** trades |
...
We add permissions to the component that retrieves and displays records in the **trade** table as follows:
