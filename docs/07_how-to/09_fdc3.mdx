...
## Example application
We have created an [example application](https://github.com/genesislcap/platform-howto/tree/master/howto-fdc3) that demonstrates how applications built using the Genesis framework can use the FDC3 standard.
