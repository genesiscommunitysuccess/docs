...
To handle the passive order book correctly, you need to remove the code for the `PASSIVE_ORDER_BOOK_INSERT` and `PASSIVE_ORDER_BOOK_DELETE` events from the file **OTE-eventhandler.kts**. 

Then you can create a new file and add the code. This is in a large snippet at the end of this section.
