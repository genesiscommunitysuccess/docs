...
The addition of this file will enable us to call bespoke events from the front end - this is simply declaring a blank "message" to send in
...
The code changes listed will also be found in TODO blocks
