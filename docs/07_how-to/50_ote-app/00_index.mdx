...
- [Improving the front end](/how-to/ote-app/ht-ote-improving-front-end/) shows you how to make adjustments to the front-end code, such as adding buttons to allows user to run end-of-day processes manually.
- [Ingesting external data](/how-to/ote-app/ht-ote-ingesting-external/) shows different ways of taking in data from an external source.
