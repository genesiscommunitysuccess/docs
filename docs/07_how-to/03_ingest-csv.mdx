...
You can also use the Data Pipeline component to send out data to external systems. This works the same way in reverse, taking data from tables in your Genseis application and transforming it it onto the format required by the target system.
