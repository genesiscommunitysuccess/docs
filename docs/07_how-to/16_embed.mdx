...
:::info
We have provided an [example React application](https://github.com/genesislcap/platform-howto/tree/master/howto-ui-integrations-react) that uses Genesis Components.
...
:::info
We have provided an [example Angular application](https://github.com/genesislcap/platform-howto/tree/master/howto-ui-integrations-angular) that uses Genesis Components.
