...
You have created a component called `NewPage`. Now you can add a form to that component. Typically, you would use a form to add a record to a table in the database.

The example below adds a simple form element to the file template. It includes properties for UISchema and JsonSchema to the NewPage
...
In the **new-page.ts** class we will add the property to get a handle on the modal instance.
...
In the **new-page.template.ts** add the element and a `ref` value so the class can open it.

In the click handler on the button we call the `show` method on the modal.
...
:::info Take a look at the code
The [**back-end code**](https://github.com/genesislcap/platform-howto/tree/4a140c118916b177c0dd5fd355a5d5ec36f7d33b/howto-uiexamples/client/src) of the example application has its own directory structure. 

From this point, you can drill down into different parts of the application, such as:

- [home](https://github.com/genesislcap/platform-howto/tree/pon/howto-charts/howto-uiexamples/client/src/routes/home), which has the three **.ts** files for the Home Page

- [foundation-layout](https://github.com/genesislcap/platform-howto/tree/4a140c118916b177c0dd5fd355a5d5ec36f7d33b/howto-uiexamples/client/src/routes/foundation-layout-intro), which defines containers that can be resized, dragged and dropped within the UI

- [charts](https://github.com/genesislcap/platform-howto/tree/pon/howto-charts/howto-uiexamples/client/src/routes/charts), which has the three **.ts** files for the Charts page

- [modal](https://github.com/genesislcap/platform-howto/tree/pon/howto-charts/howto-uiexamples/client/src/routes/modal-how-to), which has the three **.ts** files for the Modal page

:::
Before you take a look at the code, make sure you follow the relevant instructions in the [**readme file**](https://github.com/genesislcap/platform-howto/blob/4a140c118916b177c0dd5fd355a5d5ec36f7d33b/howto-uiexamples/client/README.md) for the front end. 
...
:::tip Take a look at the app
Once the back end is running, check the main [**readme file**](https://github.com/genesislcap/platform-howto/blob/4a140c118916b177c0dd5fd355a5d5ec36f7d33b/howto-uiexamples/client/README.md) before you try to run the application.
:::
