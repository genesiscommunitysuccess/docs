...
The [**back-end code**](https://github.com/genesislcap/platform-howto/tree/4a140c118916b177c0dd5fd355a5d5ec36f7d33b/howto-uiexamples/server) has its own directory structure. You can drill down through the **uiexamples-app** to see the data files and the script files that define the back-end processes.
:::
...
:::info Take a look at the code
The [**front-end code**](https://github.com/genesislcap/platform-howto/tree/4a140c118916b177c0dd5fd355a5d5ec36f7d33b/howto-uiexamples/client/src) of the example application has its own directory structure. 
