---
title: 'How to consume from and publish to a JMS Provider'
...
The Genesis Platform enables you to consume from and publish to any JMS provider, including IBM.
...
Note: the same how to guide can be followed for any other valid JMS provider, it has been explained in the relevant places where you can provide a different instance (for example; Active MQ etc).
