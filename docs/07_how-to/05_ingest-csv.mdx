...
For each Data Pipeline you need to define three main areas:

- **source** is the location of the incoming data
- **map** parses the source and maps data to fields in the application's database
- **sink** acts as an data source to update the relevant tables 
