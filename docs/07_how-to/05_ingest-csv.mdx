...
## Examples
To show how to use Data Pipeline to ingest data, we have provided an [example application](https://github.com/genesiscommunitysuccess/howto-csv-ingress/tree/main). This provides different scenarios, based on incoming data in Copp Clark holiday files. These start at the most basic case and cover increasing levels of complexity.
