...
<Grid container>
    <Grid item xs={12} md={4} sx={{padding: '1%'}}>
        <QuickCard heading="Authorisation" link="../database/fields-tables-views/fields-tables-views/" text="Understand the principles of authorising your users at every level.">
        </QuickCard>
    </Grid>
    <Grid item xs={12} md={4} sx={{padding: '1%'}}>
        <QuickCard heading="Authentication" link="../database/database-concepts/database-concepts/" text="Right now, this takes you to database concepts. Just saying.">
        </QuickCard>
    </Grid>
    <Grid item xs={12} md={4} sx={{padding: '1%'}}>
