...
Nested objects are common methods of incoporating this complexity into financial applications. 
...
You can also find useful information on [integration testing](/operations/testing/integration-testing/) for back-end components in our reference documentation.

## Full technical details

Find more details in our in our reference documentation:

- [DAOs](/database/fields-tables-views/genesisDao/) 
