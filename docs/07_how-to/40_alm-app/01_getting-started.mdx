...
[Create_Export_ALM.json](https://github.com/genesiscommunitysuccess/alm-app)
...
Make sure you are on the Summary page of Genesis Create, then click on the **Open in Genesis Cloud Workspace** tab. This generates a project and opens an IDE in the Cloud Workspace.
...
3. Select the appropriate project to open. After a moment, this displays a list of projects, and yours should be on top. The filename is the app name you specified at the beginning, plus a date and time stamp.<br></br>
Click on your project to open it.<br></br>
Now you can browse through the project that has been generated be Genesis Create.
...
4. Select **View** -> **Command Palette** and then select **Genesis Build Project**. This starts a full build. When this is complete, you will see the message **BUILD SUCCESSFUL** in the terminal tab at the bottom right of the screen.

5. Now you can initialise the database and start our server and client processes. Click the **Run and Debug** icon and select **Bootstrap + Start App**. 
...
6. When all the processes are **UP**, switch to the **PORTS** tab at the bottom. Go to the **Web** line and and click on the **Open in Browser** icon.

![](/img/ports-web.png)

This displays the web application, where you can login using:
