...
This is great, because it means that changes to the database don't change the Genesis table; if desired you can change the database technology without having to change the table definition. A good way of thinking of this is that _the table is on a different layer_ than the database.
