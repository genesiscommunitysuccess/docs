...
Genesis supports different ways of interacting with the database. Regardless of the interface used, the operations remain the same. The recommended way of accessing the database is via the [EntityDb](../../../database/database-interface/entity-db/).
