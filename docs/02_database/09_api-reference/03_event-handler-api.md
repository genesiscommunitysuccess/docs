...
| schemaValidation | `fun schemaValidation(): Boolean` | true | With this option we can disable the automatic Json Schema validation enforced by the backend. See [type-safe messages](../../03_server/09_inter-process-messages/03_type-safe-messages.md) for more information.
