...
The RxJava API is the only way of accessing the database in java. For kotlin the [async](/database/types-of-api/async/) API is preferred, but the RxJava API is also supported.
