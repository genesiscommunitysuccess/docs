...
You can define the derived field inputs as either individually specified entity fields, or as the entity itself, which 
...
- for larger tables, there could be a performance impact
