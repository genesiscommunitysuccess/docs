...
4. If there are existing fields using sequences, run the server command [CreateMissingSqlSequences](../../../05_operations/02_commands/01_server-commands.mdx#createmissingsqlsequences).

5. If you need to adjust the initial value of the sequences (for example if you are migrating data), use the server command [SetAutoIncrement](../../../05_operations/02_commands/01_server-commands.mdx#setautoincrement).
