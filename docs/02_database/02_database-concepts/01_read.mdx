...
Genesis supports a number of different read operations. Although the specifics vary between the different [interfaces](../../../database/types-of-api/types-of-api/), the underlying principles remain the same. This page explains these principles, without going into specific calls. Details of how to implement these calls, and examples can be found in the [Database Interface](../../../docs/database/database-interface/database-interface/) section of the documentation.
