...
Genesis supports a number of different write operations. This page explains the underlying principles, without going into specific calls. Details of how to implement these calls can be found in the [Database Interface](../../../database/database-interface/database-interface/) section of the documentation.
