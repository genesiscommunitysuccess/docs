...
There is a nice simple example of some logic being added to an Event Handler in our [tutorial](/getting-started/go-to-the-next-level/condition-rules/#3-update-the-event-handler).
