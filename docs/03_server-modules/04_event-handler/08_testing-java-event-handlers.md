...
You can find an [Event example](/reference/developer/api/authorisation-api) in our Authorization API pages written in Kotlin.
...
For more information on authorisation, see the [authorisation docs](/creating-applications/defining-your-application/access-control/authorisation-over/).
