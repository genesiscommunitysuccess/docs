...
Remember; if your use case is basic data ingestion, transformation and persistence to GenesisDB then you should first investigate the [Genesis Data Pipeline](/getting-started/quick-guides/loading-feed-data/sftp-and-encryption/), which offers a higher-level abstraction than seen here.
