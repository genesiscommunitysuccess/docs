...
If you add new processes, you need to add their details to the _application_**-processes.xml** file. For an example of this follow this link. [Add Process](/getting-started/quick-start/prepare-the-server-and-build/)
