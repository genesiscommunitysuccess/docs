...
To import the below live templates, download the Genesis [settings.zip](/static/file/settings.zip) file and import this into your IDE. This can be done by selecting `File > Manage IDE Settings > Import Settings`.
