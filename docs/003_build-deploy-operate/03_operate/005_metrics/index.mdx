...
| Property | Default | Explanation |
|:---|:---|:---|
| `MetricsReportIntervalSecs` | `60` | The interval in seconds at which metrics are reported to the log |
| `Slf4jReporterLoggingLevel` | `INFO` | The logging level used by the reporter |
| `Slf4jReporterLogInactive` | `false` | When `true`, inactive or zero-value meters are logged |
