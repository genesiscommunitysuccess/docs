...
The following properties can be configured in your system definition:
...
| Property | Default | Explanation |
|:---|:---|:---|
| `MetricsReportIntervalSecs` | `10` | The interval in seconds at which metrics are reported. This setting is shared across reporters (such as SLF4J and Graphite). |
