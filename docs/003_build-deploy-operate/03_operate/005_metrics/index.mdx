...
| Property | Default | Explanation |
|:---|:---|:---|
| `MetricsReportIntervalSecs` | `10` | The interval (in seconds) at which metrics are reported. This property is shared with the Graphite reporter, where it drives the Graphite step interval. |
