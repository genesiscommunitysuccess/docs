...
This command displays the system definition values that the current host or environment is using. You can use this command to quickly verify which system definition properties are active in a process.
