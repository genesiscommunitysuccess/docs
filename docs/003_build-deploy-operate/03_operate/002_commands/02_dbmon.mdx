...
<!-- INSERT AFTER: ## `KillProcess` -->

## `readSysDef`

This command reads one or more system definition property names and prints their resolved values.

###### Syntax
| Argument | Mandatory | Description | Restricted values | Default |
|---|---|---|---|---|
| PROPERTIES | yes | Space-separated list of system definition property names to read | none | none |

###### Examples

```bash
readSysDef DbHost DbPort
```
