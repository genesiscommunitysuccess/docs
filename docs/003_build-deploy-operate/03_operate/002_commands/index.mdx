...
| Node role     | The current node role in the Genesis [Cluster](/build-deploy-operate/deploy/hosting-infrastructure/containers/#clustering). Possible values: UNKNOWN, SECONDARY, PRIMARY and Consul |
