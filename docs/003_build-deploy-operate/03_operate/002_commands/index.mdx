...
The script accepts a series of arguments to establish a connection to the database (e.g. user, password, host, etc) and some specific behavior (e.g. product name, single dictionary file or composed, etc).
