...
##### Example 1: Deleting User Sessions and Related Permissions
...
##### Example 2: Deleting Trades and All Related Fees with Logging
...
##### Example 3: Single Record Cascade with Return Value
...
##### Example 4: Processing Records During Purge
