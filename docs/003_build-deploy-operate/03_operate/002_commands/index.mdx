...
| Node role     | The current node role in the Genesis Cluster, retrieved from the resource daemon. Possible values: UNKNOWN, [SECONDARY, PRIMARY](/build-deploy-operate/deploy/hosting-infrastructure/virtual-machines/#clustering) and [Consul](/build-deploy-operate/deploy/hosting-infrastructure/containers/#clustering) |
