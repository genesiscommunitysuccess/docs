...
| Gradle                             | Bundled with your Genesis application project (unless [downloading a new Create project with "Exclude Gradle Wrapper JAR" selected](/develop/development-environment/launchpad/#exclude-gradle-wrapper-jar))  |  
