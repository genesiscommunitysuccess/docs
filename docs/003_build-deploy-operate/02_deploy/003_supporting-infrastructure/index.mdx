...
| `SqlConnectionDeadlockThresholdSeconds` | The threshold in seconds before detecting a deadlock. Default 10; for more details see [deadlock detection](/develop/server-capabilities/data-access-apis/#sql-deadlock-detection)                                                                                                                                                                                                                                                   |
| `QueryReadTimeoutSeconds`               | The threshold in seconds before timing out a slow consuming query. Default 10; for more details see [Slow consuming query detection](/develop/server-capabilities/data-access-apis/#slow-consuming-query-detection)                                                                                                                                                                                                                  |
| `QueryCancelOnReadTimeout`              | Set to true to cancel slow consuming queries, set to false to log only. Default false; for more details see [Slow consuming query detection](/develop/server-capabilities/data-access-apis/#slow-consuming-query-detection)                                                                                                                                                                                                          |
| `QueryBufferSize`                       | The number of records to buffer in memory                                                                                                                                                                                                                                                                                                                                                                                            |
