...
- **alpha-system-processess.xml** 
- **alpha-service-definitions.xml**

At present, they are empty. You need to insert the details of the Data Server and Event Handler you have just created.
...
<processes>
    <process name="ALPHA_DATASERVER">
        ...
        <script>quickstart-dataserver.kts</script>
    ...
    <process name="ALPHA_EVENT_HANDLER">
        ...
        <script>quickstart-eventhandler.kts</script>
        <description>Handles events</description>
        <classpath>quickstart-messages*,quickstart-eventhandler*</classpath>
        <language>pal</language>
    </process>
</processes>
```
