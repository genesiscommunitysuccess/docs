...
The exercise is in five main steps:

1. [Create a new project](/getting-started/quick-start/#create-a-new-project).
2. [Define the data model](/getting-started/quick-start/#define-the-data-model).
3. [Add business logic](/getting-started/quick-start/#add-business-logic).
4. [Create a user interface](/getting-started/quick-start/#create-a-user-interface).
5. [Run the application](/getting-started/quick-start/#run-the-application). 
...
In the `genx` script, there is a series of questions; the following responses are used for this tutorial:
...
We want to be able to insert a grid with data into our page. For this, define `tutorialColumnDefs` in **home.template.ts**.
...
Now make another change to **home.ts**. Define a reference to `zero-ag-grid`; in class `home`, add:
...
Now you need to add [styles](/creating-applications/defining-your-application/user-interface/web-ui-reference/design-systems/customisation/app-specific/#styles) to the  file [**home.styles.ts**](/creating-applications/defining-your-application/user-interface/front-end-basics/front-end-basics/#starting-materials), using the code below.
...
In **home.styles.ts**, add [styles](/creating-applications/defining-your-application/user-interface/web-ui-reference/design-systems/customisation/app-specific/#styles) to see your changes:
...
See [here](/creating-applications/creating-a-new-project/recommended-full-stack-project-setup/configure-deployment-plugin/) for details on how to configure the Genesis deploy plugin.
