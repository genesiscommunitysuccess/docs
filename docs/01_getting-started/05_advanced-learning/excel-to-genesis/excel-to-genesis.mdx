...
The Genesis Application Platform gives you a way of turning these into applications that can be audited and maintained in a standard and controlled manner. Along the way, you can build in better workflow and usability without heavy IT development effort.
...
:::info
The above command assumes you have already set up the Genesis Application Platform on your machine and have the `ExcelToGenesis` CLI tool available.
:::
