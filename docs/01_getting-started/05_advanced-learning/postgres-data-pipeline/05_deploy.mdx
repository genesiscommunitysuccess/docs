...
After the trade is inserted go to the host where the Genesis platform is set up and execute [`DbMon`](../../../../operations/commands/dbmon/). Then query the `TRADE` table to see the inserted record. Useful operations:
