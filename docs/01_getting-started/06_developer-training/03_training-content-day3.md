...
```kotlin {5-7} title="alpha-tables-dictionary.kts"
tables {
...
```kotlin {3-7} title="alpha-fields-dictionary.kts"
fields {
    ...
...
```kotlin {3-19} title="alpha-tables-dictionary.kts"
tables {
    ...
...
```kotlin {3-9} title="alpha-tables-dictionary.kts"
tables {
    ...
...
:::info END OF DAY 3
This is the end of the day 3 of our training, to help your training journey, check out how your application should look like at the end of day 3 [here](https://github.com/genesiscommunitysuccess/devtraining-seed/tree/Exercise_3.3).
:::
