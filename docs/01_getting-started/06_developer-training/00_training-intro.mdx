...
**However, we strongly recommend that you sign up for the courses at our [Genesis Academy](https://genesis-academy.workramp.io/)**, which will take you through everything you need to know in a series of modules to build knowledge in a thorough and logical manner.
:::
...
on [GitHub](https://github.com/genesiscommunitysuccess/devtraining-alpha-simple).
