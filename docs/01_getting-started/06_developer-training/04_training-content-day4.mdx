...
Inside the **server/alpha-app/src/main/kotlin/** folder, create a new packaged called **genesis/global/**. After that, create a state machine class called `TradeStateMachine` inside that package.
