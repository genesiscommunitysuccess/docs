...
To verify the infos about this package, type `npm info @genesislcap/foundation-ui`. If everything is ok, you should see a response like this:
...
To do this training, we have set a H2 database so you don't need to worry about setting up a new database. This database will be created automatically during this training.
