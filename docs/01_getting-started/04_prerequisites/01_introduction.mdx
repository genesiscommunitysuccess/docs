...
tags:
    ...
    - introduction
---
You can run our [Quick Start](/getting-started/quick-start/hardware-and-software/) from a lightweight set-up. However, to set up a full-functioning developer workstation, you need to check out the hardware and software requirements in this section. This will get you fit to do some serious work. 
