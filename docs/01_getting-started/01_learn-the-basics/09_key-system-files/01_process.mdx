---
title: 'Key system files - processes.xml'
...
You can find more information about this subject in our reference page on the [**-processes.xml**](../../../../server/configuring-runtime/processes/) file.
