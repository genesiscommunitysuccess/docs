...
- Build applications on top of existing internal or external systems to create clearer, simpler workflows, to to add new capabilities without destabilizing your production systems.
