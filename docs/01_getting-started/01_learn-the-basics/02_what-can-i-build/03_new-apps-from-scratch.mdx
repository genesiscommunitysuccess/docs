...
You don't have to be bound by your existing systems at all. If you have a need for a new application, which looks too ambitious for now, the Genesis Application Platform could make that a realistic proposition in a realistic timeframe.
