...
To give your front end a wide range of visual possibilities, the Genesis low-code platform provides a wide range of [Web Components](https://developer.mozilla.org/en-US/docs/Web/Web_Components) (also known as Custom elements). These components work with or without your favourite framework.
