...
To do that, go to Genesis Intellij plugin and under the tab **tasks**, click on **Setup**. There you will find a script called: **genesisInstall --ignoreHooks --compactProcesses** as you can see below:
