...
- `request`: use it to call a [request server](../../../develop/server-capabilities/snapshot-queries-request-server/) resource. You must pass the request server resource name.
