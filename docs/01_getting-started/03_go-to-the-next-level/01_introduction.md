...
In this tutorial we will build a positions trading application. It is a typical the application usually found in the capital markets and highlights some of the typical use cases and features of the genesis platform.
We will now create a more sophisticated form and grid for adding information than those given in the Getting Started section of this page.
