...
## Section objectives
The goal of this section is to add a form that enables us to insert trades into our database. In the Qick Start, we used entity-management to do this; but here, we are going to create a form ourselves.
