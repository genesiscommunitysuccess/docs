...
1. Run 'npm -v' to make sure that you have the correct versions of npm. If you have an older version of npm, make sure you uninstall it before downloading and installing the recommended version.
