...
By default **genesis-system-definition.kts** file is set with following options, this creates H2 file-based database under `{project_folder}/server/h2/` folder in the name of `test` as mentioned in `DbHost` property.
