...
For this quick start, we are not creating joins. But if you want to find out more, check our [reference pages on views](/database/fields-tables-views/views/views-basics/#joins).
