...
The seed projects available range from bare-bones skeleton projects to example applications.
...
Before installing GenX you need to [configure the Genesis npm repository](/creating-applications/getting-ready-to-develop/workstation-setup/#npmrc-set-up)
...
First up you'll be prompted to supply your Genesis artifactory credentials [used when setting up your .npmrc](/creating-applications/getting-ready-to-develop/workstation-setup/#npmrc-set-up)
...
- the [**web** project structure](/creating-applications/creating-a-new-project/alternative_options_supported/web-project-setup/#available-generators).
- the [**jvm** project structure](/creating-applications/defining-your-application/intro/).
:::