---
title: 'Create project using GenX'
...
Now we're ready to use the tool, simply type genx to start:
...
Enter the local directory you want to create the app in (uppercase letter is the default choice if nothing entered)
