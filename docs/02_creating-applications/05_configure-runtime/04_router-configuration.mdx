...
In the following examples, a `FileEndpointCommon` class has also been created to methods that may be needed across multiple endpoints:

####FileEndpointCommon
<Tabs defaultValue="kotlin" values={[{ label: 'Kotlin', value: 'kotlin', }, { label: 'Java', value: 'java', }]}>
<TabItem value="kotlin">
```kotlin
object FileEndpointCommon {
...
More information on how Testing works in Genesis is available [here](03_managing-application/04_test).
