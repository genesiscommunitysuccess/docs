...
```java
    ...
    public void testTradeInsert() throws InterruptedException {
        ...
        Trade trade2 = getRxDb().entityDb().get(Trade.byId("40")).blockingGet();
...
<TabItem value="java">
    ...
    ```java
    public class TradingEventHandlerTestJavaAbstract2 extends AbstractGenesisTestSupport<EventResponse> {

        public TradingEventHandlerTestJavaAbstract2() {
            super(GenesisTestConfig.builder()
