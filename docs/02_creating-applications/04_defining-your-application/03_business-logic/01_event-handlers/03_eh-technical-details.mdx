...
It is possible to define an Event Handler in Java, and we have included Java examples here. You can find out more about these examples in our page on the [Event Handler API](/reference/developer/api/event-handler-api/#rx3eventhandler). However, we strongly advise you to create your Event Handler using Kotlin; it is a considerably more efficient method. 
