...
to validate input and insert a record in the database.
```kotlin
...
This is an example on how to reuse data between 
...
This is an example on how to add [authorization](/creating-applications/defining-your-application/business-logic/event-handlers/eh-technical-details/#permissions-and-permissioncodes)
to an event handler.
```kotlin
...
Below is an example on how to make an event handler [transactional](/creating-applications/defining-your-application/business-logic/event-handlers/eh-advanced-technical-details/#acid-guaranteed)
```kotlin
