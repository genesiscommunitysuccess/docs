...
There is a nice simple example of some logic being added to an event handler in our [tutorial](/tutorials/building-an-application/add-event-handler/), and below we have some other examples of different ways to use an event handler.
&nbsp;  
&nbsp;  
&nbsp;  
