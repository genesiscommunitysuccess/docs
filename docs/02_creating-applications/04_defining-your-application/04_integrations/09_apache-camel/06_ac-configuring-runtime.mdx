...
### Dependencies
The Genesis Platform only includes the `camel-core` dependency. You will want to declare additional dependencies to make best use of the different available Camel components.
...
Where the position-camel-libs module may have similiar dependencies to the following:
