...
Apache Camel integrations are defined within the **\*-camel.kts** file located in the **src/main/resources/scripts** directory within your application's **_application_-script-config** submodule.