...
Apache Camel integrations are defined within the **\*-camel.kts** file located in your applications's _application_**-config** submodule in the **resources/scripts** directory.