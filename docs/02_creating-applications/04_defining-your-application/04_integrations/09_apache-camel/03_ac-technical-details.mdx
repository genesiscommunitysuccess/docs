...
Here is a simple example of a** *-camel.kts** file. It defines a single route leveraging a range of Camel configuration options which we'll explore in a little more detail below:
```kotlin
camel {
    routeHandler {
