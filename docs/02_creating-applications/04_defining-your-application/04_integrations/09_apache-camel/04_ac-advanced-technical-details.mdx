...
Remember; if your use case is basic data ingestion, transformation and persistence to GenesisDB then you
should first investigate the [Genesis Data Pipeline](/creating-applications/defining-your-application/integrations/data-pipeline/overview/) which offers a
higher level abstraction than seen here.
