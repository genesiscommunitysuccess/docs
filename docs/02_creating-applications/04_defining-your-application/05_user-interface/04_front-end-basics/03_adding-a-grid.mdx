...
You can also create your own grid component, similarly to the way you created the `TestPage` component. In the example below, the component is called `positions-ag-grid`. 

, and in doing so, **provide custom styles**.
