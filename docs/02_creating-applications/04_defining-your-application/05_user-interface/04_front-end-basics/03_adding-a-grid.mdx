...
Then, in the export, we have added the line `${repeat(() => tradeColumnDefs, html` `
...
You can also create our own grid component, similarly to how we created our `TestPage` component, and in doing so, **provide custom styles**.
