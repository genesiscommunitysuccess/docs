...
sidebar_label: 'Adding a new empty page'
sidebar_position: 2
id: new-empty-page
---
...
Step 3: Create three new files under our new directory, for the component itself, its layout and styles/css.
...
We need to add a new mapping to our router's configuration. Typically this is done in **src/routes/config.ts**.
