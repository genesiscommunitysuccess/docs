...
You will also be required to declare the Request Server component as described in the [Configuring runtime](/creating-applications/defining-your-application/user-interface/request-servers/rs-configure-runtime/) page.
