...
You can include multiple request servers definitions in a single file.
...
You can also define derived fields which will be included on the reply, where the input for the derived field is the reply entity.
