...
When you generate a design system using [CLI](/creating-applications/defining-your-application/user-interface/web-ui-reference/cli/) it will automatically extend a base design system that we have provided.
