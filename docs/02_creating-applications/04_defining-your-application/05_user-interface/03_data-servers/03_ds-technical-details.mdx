...
This enables the type-aware criteria evaluator. Defaults to `false`. [Click here to read more](/creating-applications/defining-your-application/user-interface/data-servers/#enabletypeawarecriteriaevaluator).
