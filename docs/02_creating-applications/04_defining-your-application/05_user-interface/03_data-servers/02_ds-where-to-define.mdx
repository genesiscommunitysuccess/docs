...
Note, you will also need to declare your Data Server within the [runtime configuration](/creating-applications/defining-your-application/user-interface/data-servers/ds-configure-runtime/).
