...
Views are defined in the file _application-name-**-view-dictionary.kts**. 

For example, if your application is called **position**, then the file name will be **position-view-dictionary.kts**.
