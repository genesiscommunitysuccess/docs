...
You can also access derived fields that were defined in the tables dictionary like any other field. For example, if table TRADE had a derived field named FAVOURITE it could be used like below.
