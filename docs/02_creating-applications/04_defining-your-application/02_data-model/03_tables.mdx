...
Tables are used to store the underlying data. They are made up of [fields](/creating-applications/defining-your-application/data-model/fields/fields) and must also at least define a `primaryKey` which tells the underlying database how to index the table's data
