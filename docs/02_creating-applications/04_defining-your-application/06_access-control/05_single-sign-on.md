...
| MetaData | For an IDP and SP to work  together, certain parts of the configuration need to be shared; this is the meta data. An SP would need to know the IDP meta data, and the IDP might need to know the SP meta data | see below  |
