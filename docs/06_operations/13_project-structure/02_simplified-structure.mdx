...
Although now it is possible to have all your application code in a single module, you may still want to extract parts of the code for easier maintenance.

To add a new module: 
1. Create a sub-directory in the /server directory.
2. Add source directories as required (src/main/java, src/main/kotlin, /src/main/resources)
