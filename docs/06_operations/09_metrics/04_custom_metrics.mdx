...
Let us consider an example. When you track the number of messages received, generally, you are interested in the number of messages a system handles over an interval, rather than the total number of messages received since the last restart. 
