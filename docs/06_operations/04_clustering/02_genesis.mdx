...
You can customise our [metrics](/operations/metrics/introduction/) to output information such as the number of transactions per Event Handler, for example. You can then choose how to store and report on the data points.
