...
1. Create or use an existing Genesis project. See our [Quick Start guide](../../../getting-started/quick-start/new-project-using-genx/create-a-new-project/) for details of creating a new project.
