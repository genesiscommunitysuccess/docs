 ...
 * Genesis Application Platform frameworks (supplied as zip files)
...
Default project creation using the CLI tool [genx](../../../getting-started/quick-start/new-project-using-genx/create-a-new-project) will populate
...
of web repositories are available [here](../../../getting-started/quick-start/hardware-and-software/).
