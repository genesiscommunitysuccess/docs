...
- fix: Set region explicitly in s3 client construction to prevent errors on servers running IMDS v2 security (DOCMGMT-92) by @khouari1 in https://github.com/genesislcap/platform-documents/pull/409
