...
- feat(build-gradle-plugin): Add new gradle task named `checkAuthPermissions` to check permissions/auth configuration (GSF-7506) by @khouari1 in https://github.com/genesislcap/genesis-server/pull/5307

###### Fixes

- fix(genesis-clustersupport): Process monitors in STANDBY state should be reported as "failed" checks to Consul (GSF-7520) by @khouari1 in https://github.com/genesislcap/genesis-server/pull/5309
- fix(genesis-net): create request log per process (GSF-7505) by @kievitsp in https://github.com/genesislcap/genesis-server/pull/5310

#### 8.14.7

###### Features

- feat(coreproduct): Support compiled GPal definitions (GSF-7503) by @khouari1 in https://github.com/genesislcap/genesis-server/pull/5243
