...
```
:::tip
For any other issues, Jetbrains has additionally released a very comprehensive [Kotlin 2.0 compiled migration guide](https://kotlinlang.org/docs/k2-compiler-migration-guide.html).
:::
