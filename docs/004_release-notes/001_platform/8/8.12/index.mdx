...
### Removing `debugMode` property from Dockerfile

This property wasn't working. If you have it in any of your Dockerfiles and receive an error upon upgrading to 8.12.0+, please just remove the property from your file.
