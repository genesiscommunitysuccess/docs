...
If you are currently using the same instance of a camel file source for multiple pipelines, this will result in an error where the pipeline is not able to start.

You can resolve this by creating a new instance of the source for each pipeline.
