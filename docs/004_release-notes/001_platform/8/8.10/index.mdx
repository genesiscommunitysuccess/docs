...
- fix(db): Change default Backwards Join Cache mode to Sync (GSF-7267) by @rafaelnferreira in https://github.com/genesislcap/genesis-server/pull/4318
- fix: Fix `ClassCastException` issue in backwards join cache (GSF-7266) by @rafaelnferreira in https://github.com/genesislcap/genesis-server/pull/4319
