...
<a href="/file/update_gradle_wrappers.sh" download="update_gradle_wrappers.sh">Download script</a>  
[Download script user guide](/file/update_gradle_wrappers_guide.pdf)
