...
Additionally, genesis provides a `bash` script that can automate the gradle wrapper upgrade step for a streamlined process.
See bash script [here](https://genesisglobal.jfrog.io/ui/repos/tree/General/platform-release-notes/utilities/update_gradle_wrappers.sh) and guide [here](https://genesisglobal.jfrog.io/ui/repos/tree/General/platform-release-notes/utilities/update_gradle_wrappers_guide.pdf).
