...
After following these seven steps, two new processes will appear in your **mon** tab: **GENESIS_NOTIFY_DISPATCHER** and **GENESIS_NOTIFY_MANAGER**. These are the processes that manage the Notifications module.
