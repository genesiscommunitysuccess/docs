...
It creates a single-page route [Notification Dashboard](../notify-ui-components#notification-dashboard) component.
...
Inbox Flyout is a ready-to-use component for [Inbox](../notify-ui-components#inbox) functionality.
