...
For permissions/rights and how they relate to users, check the [authorisation](/server/access-control/authorisation#users-profiles-and-right-codes) section.
