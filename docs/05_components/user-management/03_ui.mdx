...
The User Management component contains the personal data of all system's users, such as first, last name and email.

![User Management](/img/pbc-user-management/ui/01_user_management.png)

When you add or edit an user you need to provide data for these fields:
...
You have the option to add and use the components separately.
