...
The data sources for generating reports are the resources you have specified in your [Data Server](/server/data-server/basics/) and [Request Server](/server/request-server/basics/). However, these resources are not available by default (in case they contain sensitive information). 
