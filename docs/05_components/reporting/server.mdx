...
Here is an example `REPORTING_DATASOURCE_LIST` from a **reporting-system-definition.kts** file. It makes two Data Server queries and one Request Server requestReply available to the Reporting Server:
