...
Here is an example `REPORTING_DATASOURCE_LIST` from a **reporting-system-definition.kts** file. It makes a Data Server query and a Request Server requestReply available to the Reporting Server:

```kotlin
item("REPORTING_DATASOURCE_LIST", listOf("ALL_SAVED_REPORTS", "SAVED_REPORTS"))
```
