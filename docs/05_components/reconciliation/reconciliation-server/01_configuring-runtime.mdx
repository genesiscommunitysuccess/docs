...
:::warning
**This guide assumes you have not used GenX to add the Reconciliation component.** You should only add components manually if your project is on an older version of the platform, which that does not support [GenX Add](../../../../components/reconciliation/reconciliation-installation).
:::
