...
To construct a multiform POST request, you must provide a key for the form data, and the value is the file content. The headers must also be set correctly:
```
