...
To link assets (css, image files etc...), you need to define `eventHandler` codeblock. This must insert one or more objects into the `TemplateAsset` table. Use the following as an example.
