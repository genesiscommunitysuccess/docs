...
:::warning **This guide assumes you have not used GenX to add the Document Management component.** You should only add components manually if your project is on an older framework version that does not support [GenX Add](../../../../components/doc-management/doc-management-ui-config).
