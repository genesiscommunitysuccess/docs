...
It should be noted that AWS has a minimum part size of 5MiB. Therefore, setting this configuration to lower than 5MiB and uploading a file smaller than 5MiB but greater than the limit will fail.
