...
```
Once you have set your `STORAGE_STRATEGY`, you must set your storage solution specify configuration.

## Local file storage
When using local file storage, your files are stored under your specified folder inside your **genesis-home/runtime/fileupload/** folder is created automatically.
