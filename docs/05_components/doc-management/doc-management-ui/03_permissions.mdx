...
Your users need to be permissioned to use different features the Document Management component.

Right codes control access to these features. Here are the codes available:

Please see below for the permission codes needed within the Document 
