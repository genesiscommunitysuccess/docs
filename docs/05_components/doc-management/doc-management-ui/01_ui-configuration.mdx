...
Note that each component is linked to a permission, which allows the user to view it or perform a specific action; check the [permissions](../../../components/doc-management/doc-management-ui/permissions) available and ensure that your user is permissioned accordingly.
