...
:::info
You can handle two consolidation operations with a single consolidator block simply by including two group by statements [documented here](/develop/server-capabilities/real-time-aggregation-consolidator/).
