...
### Checking the file
Some of the TODOs involve large code snippets. You are going to make major changes to this file. So, before you change anything, take some time to look through the file.
...
When you are cutting and pasting the code in the TODO items, make sure you copy the complete code each time - word wrapping makes it easy to get this wrong if you have a small window.
