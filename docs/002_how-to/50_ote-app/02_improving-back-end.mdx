...
### Checking the file
Before you change anything, take some time to look through the file.
...
1. Copy the code from that item.
2. Insert it into the relevant point in the code itself. 
3. Remove the asterisk character from the beginning of each line!
