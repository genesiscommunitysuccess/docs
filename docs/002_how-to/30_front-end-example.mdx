...
keywords: [react, web components, front end, frontend, forms, modal, flyout]
tags:
    - react
    - web components
    - front end
...
For a React-focused walkthrough, see the [React integration guide](/develop/client-capabilities/framework-integration/client-framework-integration-react) and the [example React application](https://github.com/genesiscommunitysuccess/howto-ui-integrations-react).

We have created an [example application](https://github.com/genesiscommunitysuccess/howto-uiexamples) to demonstrate the things you can set up on the front end of a Genesis application (web components).
