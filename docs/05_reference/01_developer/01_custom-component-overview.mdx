...
The point of a custom component is to implement custom logic for your application. If you create a custom component, you must configure it in [Genesis System Definition](/creating-applications/configure-runtime/system-definitions/). For testing, follow the [standard Genesis practice](/managing-applications/test/testing/).
