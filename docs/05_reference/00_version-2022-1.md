...
## CLI tool for new full-stack project creation
...
A new optional Reporting component is now available, which allows users to create report specifications, run them or save them for later use.
