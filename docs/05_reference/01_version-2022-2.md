...
- Conventional commits to foundation-ui repo, commit linting etc, have been introduced. This allows us to create detailed release notes and correctly set semver numbers across our packages.
- Improved other linting task settings.
