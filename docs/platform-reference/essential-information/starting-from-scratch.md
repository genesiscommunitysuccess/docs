...
---
This section walks you though how to set up a Genesis project using a Maven archetype. At the end you will have generated fields that can be used in tables and views.
