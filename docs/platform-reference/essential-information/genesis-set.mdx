...
Genesis Set is a key/value store, and it is **generic** message type used to communicate with other Genesis microservices. Sets can store primitives as well as other sets.

Examples: 

1. GenesisSet to send message to Event handler service
...
2. GenesisSet to send message to request reply service
...
: This method will be used while creating GenesisSet from Java class. GenesisSetBuilder creates new instance of GenesisSet and use `build` method to get instance of GenesisSet as shown in above examples
