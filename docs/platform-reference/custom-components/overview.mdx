...
A custom component can be used to implement custom logic for your service. Configuration for your component can be defined in [Genesis System Definition](/platform-reference/essential-information/system_definitions-latest.md) and
