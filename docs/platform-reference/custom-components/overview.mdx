...
A custom component can implement custom logic for your application. You must configure the component in [Genesis System Definition](/platform-reference/essential-information/system_definitions-latest.md). For testing, follow the [standard Genesis practice](/platform-reference/testing/testing.mdx).
...
All classes requiring creation by the genesis startup need to have this Annotation, this also acts as a singleton.
