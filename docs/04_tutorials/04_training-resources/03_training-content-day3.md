...
Now the time has come to start writing some unit tests for our application.

Let's create a unit test that inserts and retrieves some data using Genesis' unit test support components, in summary:
