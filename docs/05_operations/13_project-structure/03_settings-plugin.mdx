...
- Consistent configuration. For example, you won't need to remember to add a dictionary dependency as the Settings plugin will add it for you.
- Simplified development experience in the IntelliJ plugin.
