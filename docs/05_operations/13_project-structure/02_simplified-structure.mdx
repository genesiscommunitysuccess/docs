...
To create a new project with the Simplified structure,  use genx with the blank-app-seed but also specify the following option `--ref simple-app-seed`.

```bash
npx -y @genesislcap/genx@latest init <app-name> --ref simple-app-seed
```
