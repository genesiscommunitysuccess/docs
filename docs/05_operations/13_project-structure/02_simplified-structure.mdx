...
| -messages | Removed. |
| -config | Removed. A -config.jar will be built from the main module and wil contain your project's config and script files. It will be in the main module `build/libs` folder. |
