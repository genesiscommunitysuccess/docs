...
| Argument                               | Argument long name                   | Mandatory | Description                                 | Restricted values | Default |
|----------------------------------------|--------------------------------------|-----------|---------------------------------------------------------------------------------------|-------------------|-------|
| -c   <!-- LogLevel -c -->               |  --class `<class name>`              | no         | changes log level on the defined class       | none                | none |
...
| -h   <!-- LogLevel -h -->              |  --help                              | no         | show help on the command                     | none  | none  |
| -l  <!-- LogLevel -l -->               |  --level `<log level>`               | no         | log level - if log level is not correct it will be set automatically to   DEBUG level | none     | none  |
