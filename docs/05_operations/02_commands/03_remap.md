...
|          | --skipTableDump  <!-- remap --skipTableDump -->      | no        | Skips the back-up of old data and runs much quicker; **use with caution** - you will not be able to [roll back](../../05_operations/02_commands/03_remap.md#rollback) unless you have specifically made a full back-up | No                 |
