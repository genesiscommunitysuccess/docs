...
|          | --skipTableDump  <!-- remap --skipTableDump -->      | no        | Skips the back-up of old data and runs much quicker; **use with caution** - you will not be able to [roll back](../../../operations/commands/remap/#rollback) unless you have specifically made a full back-up | No                 |
