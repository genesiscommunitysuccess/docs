...
To use Genesis Jakarta Messaging on the platform, you must install **ArtemisMQ in the host** (or hosts in case of [HA](#high-avaiability)). This is described in the [ArtemisMQ documentation](https://activemq.apache.org/components/artemis/documentation/).
