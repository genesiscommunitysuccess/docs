...
- [ZeroMQ](02_zeromq.mdx) (Default) - a decentralised peer-to-peer set-up, which relies on a fixed cluster size
- [MQTT](03_mqtt.mdx) - use an independent MQTT broker if you want to allow dynamic scaling
- [JMS](04_jms.mdx) - use an independent JMS broker (ArtemisMQ) to improve robustness of message delivery
