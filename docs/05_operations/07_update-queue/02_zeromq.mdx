...
It works because the GENESIS_CLUSTER process knows (via [clustering](../03_clustering/01_overview.mdx)) all the nodes within the cluster - so it can broadcast and consume appropriately.
