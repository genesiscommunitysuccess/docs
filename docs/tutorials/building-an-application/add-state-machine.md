...
Note that event handlers have already been generated by the AppGen process you ran earlier. Once you have added add a new field to the data model and then edit the event handler to add controlled transitions from one state to another.
