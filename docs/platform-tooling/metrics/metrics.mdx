...
To make use of the metric calls, you must set `MetricsEnabled` to true. In addition, you should define the `MetricsReportType`
...
You can use the method `MetricUtils.getInstance()` repeatedly in your code to get an instance of MetricUtils and make appropriate metrics calls, against the various metric types. Below are some examples.
