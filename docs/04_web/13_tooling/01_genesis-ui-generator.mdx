...
To create a new route or a new component, define its name and click on **Create**.
...
It's also possible to create a grid or a chart with a datasource plugged into the back end. All the queries available are identified by the AI and will be loaded for the user to pick up. After clicking on Create, all necessary files will be created automatically in the correct folder.
