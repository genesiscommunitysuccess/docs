...
This example creates a grid with a server side row model allowing requesting data on demand as user scrolls.
...
This example creates a grid with a server side row model allowing pagination with a page size of 10
