...
:::tip A different approach to creating multiple columns
...
Now, in the context/component's own class, you can define a new column. The code below defines a `field` called **PRICE**. There must be a field with this name in the back end. Note that we pin this field to the right.
