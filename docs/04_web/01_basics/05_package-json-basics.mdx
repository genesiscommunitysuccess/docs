...
:::tip
As a general rule you'll be making two categories of changes, and understanding each one will help you understand which package.json you'll be changing. A module level change such as adding a dependency to an app or package in your app will require you to update the package.json of that app or package. If you want to add a script or dependency to help manage your repository, this will go into your top level package.json. This is a special package.json which only contains scripts and dependencies which you use during CI or developing locally, and won't contain any tools or dependencies that end users will interact with.
:::
