...
You can add extra pages by creating subfolders and adding the three filetypes for each page that you want to create. Take care to create your subfolders in a logical way, because these become the route to each page. 
