...
This page looks at how you can apply criteria matching when you connect to [Data Server](/server/data-server/introduction/) and [Request Server](/server/request-server/introduction/) resources.
