...
Setting up SSO is primarily [a back-end task](../../../server/access-control/sso_jwt.md); however, there is a small amount of front-end [sso configuration](docs/api/foundation-login.loginconfig.sso.md) required.
