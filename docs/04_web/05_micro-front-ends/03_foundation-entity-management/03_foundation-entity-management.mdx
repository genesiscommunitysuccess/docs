...
| `crud-menu-position`       | specifies the position of the CRUD action buttons (e.g., Add, Edit, Delete) within the grid. Possible values are: **column**, **top**, **bottom**, **action**, **none** (no menu displayed) | No  |
| `crud-menu-style`          | defines the visual style of the CRUD action buttons. Possible values are **default** (displays the buttons side by side), **actions-vertical** (displayed vertically), **actions-horizontal** (displayed horizontally) | No  |
