...
1 - Add @genesislcap/foundation-entity-management as a dependency in your package.json file. Whenever you change the dependencies of your project, run the $ npm run bootstrap command again. For more information, see the package.json basics page.
2- Import and declare the class in the page of the class where you wish to use the Entity Manager.
3 Implement `entity-management` in the template html where required.
...
As long as your back end has the correct resources, you can now see the grid in the Home page.
