...
The boolean renderer creates a `multiselect` component with options from datasource.
...
This is a boolean renderer that creates a `select` component with options.
