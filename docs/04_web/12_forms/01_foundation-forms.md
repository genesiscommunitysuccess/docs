...
This should generate a working form based on the `JSON schema` for that endpoint. The DevTools console will output an autogenerated `UI schema` that you can use to configure the form.
