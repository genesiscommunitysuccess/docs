...
To insert the automatically-generated JSON schema for this resource in your **templeate.ts** file, use the code below:
...
You can create your own JSON schema on the client side if you want to specify your own form.
