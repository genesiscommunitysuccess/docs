...
First, you'll need to make sure that you have Node.js >= 20 and npm >= 10 installed. You can learn more and download that [on the official site](https://nodejs.org/).
