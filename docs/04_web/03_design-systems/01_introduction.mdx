...
## Documentation site
The Documentation site presents the different parts of a design system together alongside best-practice recommendations. Component documentation will often include live previews to showcase available configuration options.
...
When you generate a design system using the [CLI](../../../getting-started/quick-start/new-project-using-genx/create-a-new-project/) it will automatically extend a base design system that we have provided.
