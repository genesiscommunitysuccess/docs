...
```typescript
EventEmitter: <TEventDetailMap extends EventDetailMap, TTarget extends HTMLElement & FASTElement = HTMLElement & FASTElement>(Target: EventEmitterTarget<TTarget>) => abstract new (...args: any[]) => {
