...
A batch pipeline will only run once and will need to be triggered manually via the use of its execute method. The pipeline can be retrieved from the Pipeline Manager class.
