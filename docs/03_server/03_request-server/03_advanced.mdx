...
When you use [Custom Request Servers](#custom-request-servers), permissioning works the same way, the only difference being the fact you can use any class/DAO as input and output classes.
