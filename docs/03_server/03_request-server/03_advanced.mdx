...
Within a simplified project, we recommend that you locate your classes within the main/kotlin messages folder of your project structure. You need to ensure that the _app-name_**-reqrep.kts** file has a dependency on the _app-name_**-app** ScriptModule
