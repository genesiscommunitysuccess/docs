...
You then need to create your new test cases. Note that the authorisation for Request Servers is on the outgoing message.
The Request Server filters out any values to which the requesting user has no access. 
