...
Before you begin writing tests for this request Server, you need to inject a request server client, and define our workflow:
...
At this point we have tested our very simple Request Server. We haven't even had to use the database! However, we have covered the baasics of communication between tests and Request Servers.
