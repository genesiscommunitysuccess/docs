...
We shall  use a very simple example and work through the communitation between our tests and the Data Server we are testing. This example relies on [**GenesisJunit](/operations/testing/integration-testing/).
