...
- If you always want to send new updates to the front end automatically once they occur in the server, regardless of the value of REVERSE, use normal DATA_LOGONs with MOVING_VIEW set to false and with no MAX_ROWS = MAX_VIEW.  
:::
