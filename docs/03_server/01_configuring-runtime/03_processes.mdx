...
It is created automatically when you start a new Genesis project using Genesis Create or the [GenX CLI tool](../../../getting-started/quick-start/new-project-using-genx/create-a-new-project/), but you might well want to update it - and you certainly want to take a good look at it.
...
| config          | If the process has [a **process-config.kts** file](../../../server/configuring-runtime/cache/), you must specify it using this tag.                                                                                                                                                                                                                                                                                                                                                                                    | Yes       | None               |
| script          | If the process needs one or many GPAL script files, you must specify them using this tag. The filenames must be provided in a comma-separated list.                                                                                                                                                                                                                                                                                                                                                                    | Yes       | None               |
