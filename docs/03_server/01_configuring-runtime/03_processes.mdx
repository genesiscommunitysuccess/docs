...
| script          | If the process needs one or many GPAL script files, you must specify them using this tag. The filenames must be provided in a comma-separated list.                                                                                                                                                                                                                                                                                                                                                                    | No       | None               |
