...
**DbLayer**: Default value is set to FDB. If you want to use PostgreSQL, or MSSQL, then you need to change this value and then [change the value of the DbHost item](../../../server/configuring-runtime/setting-the-database-technology/).
