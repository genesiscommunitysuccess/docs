...
As we have mentioned before, all events created in the **eventhandler.kts** file are automatically exposed as a [REST endpoints](../../../server/integration/rest-endpoints/introduction/).
