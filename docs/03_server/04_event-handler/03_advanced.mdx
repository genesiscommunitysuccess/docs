...
The example below shows custom logic using a table called RESTRICTED_SYMBOL to prevent restricted symbols from being added to the system, as well as checking user right codes:
