...
To help with external integration and testing, [Open API](/server/integration/rest-endpoints/introduction/) specifications are generated for each resource in the Event Handler.
