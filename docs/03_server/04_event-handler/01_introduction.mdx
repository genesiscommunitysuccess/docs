...
- **Java** Event Handlers are implemented using **RxJava3** and **Sync** Event Handlers only. These are described in our page on the [Event Handler API](../../../server/api-reference/event-handler-api/#rx3eventhandler)
