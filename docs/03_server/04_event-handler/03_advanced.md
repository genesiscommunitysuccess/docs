...
Here is an example of a GPAL Event Handler definition where we use the `event.userName` to gain access to the user who triggered the event, and check if it is a valid user for the operation:
