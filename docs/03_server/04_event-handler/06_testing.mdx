...
This testing relies on [**GenesisJunit**](/operations/testing/integration-testing/), which is designed to make testing easy.
...
### Inject an Event Handler client
...
For more details about testing with Genesis, take a look at our [integration test documentation](/operations/testing/integration-testing).
