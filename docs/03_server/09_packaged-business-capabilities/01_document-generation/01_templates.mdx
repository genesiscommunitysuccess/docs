...
Thymeleaf has the capability of processing complex data objects, as a result the HTML template can include for loops like the above example. (See [Thymeleaf documentation](https://www.thymeleaf.org/documentation.html) for more details.)
