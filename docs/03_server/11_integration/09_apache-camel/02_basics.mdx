...
Apache Camel integrations are defined within your application's **jvm/**_app-name_**-script-config/**_app-name_**-camel.kts** file.
...
:::info
If you want to ingest a CSV directly into GenesisDB rather than calling a Request Server, you might want to investigate the Genesis Data Pipeline [batch pipeline](../../../../server/data-pipelines/basics/#batch-pipeline) first.
:::
