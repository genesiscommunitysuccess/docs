...
Remember; if your use case is basic data ingestion, transformation and persistence to GenesisDB, then you should first investigate the [Genesis Data Pipeline](../../../../server/data-pipelines/introduction/), which offers a higher-level abstraction than seen here.
