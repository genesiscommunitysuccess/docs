...
For more information on the above process tags, see the page on [configuring runtime processes](/docs/develop/server-capabilities/runtime-configuration/processes/).

2. Create a Kotlin script file named `*-streamer-client.kts` under `scripts`. Add the following information:
