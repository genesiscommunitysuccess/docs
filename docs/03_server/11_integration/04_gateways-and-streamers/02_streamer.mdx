...
2. Create a Kotlin script file named _app-name_**-streamer.kts** under **jvm/**_app-name_**-script-config**. Add the following information:
    * A stream name
...
## Metrics
You can find details of how to use metrics with Streamer in our pages on [metrics](/operations/metrics/service-metrics/#streamer).
