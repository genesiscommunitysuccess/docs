...
| operators | Transform data from the data source to match the requirements of the database|
| sink | Inserts the mapped data to the database |
...
For more complex requirements, you can create your own transformer in a separate file. You can see this in two of our examples.
...
However, there are additional helpers for things such as `onCompletion`. This enables you to specify what happens after the file processing is complete. 
