...
In most cases, you will create [Event Handlers](/develop/server-capabilities/core-business-logic-event-handler/) in a kts file using GPAL. This offers a method with succinct code and a good degree of flexibility.
