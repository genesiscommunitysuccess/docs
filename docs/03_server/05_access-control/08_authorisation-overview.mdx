...
* Request Server - the parameter will be of type [GenesisSet](../../03_server/09_network-messages/02_genesisset.mdx), as Request Server definitions can heavily customise the inbound metadata, and it might not necessarily match any pre-existing [generated entity](../../../database/data-types/table-entities/).
