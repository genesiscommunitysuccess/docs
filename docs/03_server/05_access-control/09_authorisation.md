...
| updateOnEntityFields | Specify a list of fields belonging to the entity table; an update to a field on this list should trigger a re-check of this entity's permissions | No. If this is left undefined, permissions checks will be triggered for any field change at the entity level. |
