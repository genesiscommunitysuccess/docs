...
You define a Consolidator service in a Kotlin script file:<br></br>**server/**_appname_**/src/main/genesis/scripts/**_appname_**-consolidator.kts**.

Within the file, you can define as many Consolidators as you like. Each one is specified in a `Consolidator` block of code.
