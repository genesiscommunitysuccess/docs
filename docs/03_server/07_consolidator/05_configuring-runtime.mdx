...
Here you can pass the `--coldStart` argument which cold-starts the process. This is useful to avoid the danger of losing your calculated data. More info can be found in the [startProcess command](../basics/#the-startprocess-command-cold-start).
