...
In this case, we want to ensure that we have a database, seeded with information, and that our Event Handler configuration is used to create our Event Handler. 

We also need to:

- add the required packages
- set genesis home
- set the `IS_SCRIPT` System Definition property to true (this is required as part of the Event Handler initialisation)
...
For more information about `AbstractGenesisTestSupport`, see the [legacy Testing pages](/operations/testing/integration-testing-previous/#abstractgenesistestsupport).
