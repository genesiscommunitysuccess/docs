...
You define your State Machine as a specific type of [Event Handler](/docs/develop/server-capabilities/core-business-logic-event-handler/). 
...
You can click to view the whole file for this example State Machine and see how each of the events is handled.
