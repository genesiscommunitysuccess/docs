...
:::note
Genesis Launcher only supports projects that have the [simplified structure](/operations/project-structure/introduction/),
or projects that have the [Genesis Gradle Settings plugin](/operations/project-structure/settings-plugin/) enabled.

All projects generated through Genesis Create have the simplified structure. For all new projects generated through Create, the Genesis Gradle Settings plugin is enabled by default.
:::
