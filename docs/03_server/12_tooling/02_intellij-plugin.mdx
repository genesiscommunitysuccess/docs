...
By default, processes log the level that they are set to. You can dynamically change this [using the terminal to run the LogLevel script] (#using-the-terminal).
