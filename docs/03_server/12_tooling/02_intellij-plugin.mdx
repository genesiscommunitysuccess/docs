...
Note, by default processes will log the level they are set to. You can dynamically change this [using the terminal to run the LogLevel script] (https://learn.genesis.global/docs/server/tooling/intellij-plugin/#using-the-terminal)
