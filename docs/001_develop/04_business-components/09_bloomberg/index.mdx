...
### Common donfiguration
The direct and Data Pipelines approaches both use a common configuration structure in GPAL, which offers auto-complete and type-safe configuration for initializing a Bloomberg client.
