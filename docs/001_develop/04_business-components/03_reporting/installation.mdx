...
The best way to add the Reporting component to a new application is to use GenX - see [GenX CLI](/docs/develop/development-environment/genx/) for more details.
