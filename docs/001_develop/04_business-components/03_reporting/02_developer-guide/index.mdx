...
| `RunReport` | Execute an existing report config, and view + download generated reports (even if `ViewReport` isn't enabled). |
| `ViewReport` | View and download generated reports. |
