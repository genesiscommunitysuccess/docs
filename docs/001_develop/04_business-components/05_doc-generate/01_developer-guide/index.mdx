...
This is a non-nullable String which cannot be blank and represents the following in order of priority:

1. the `FileStorageId` of the template which has been uploaded to the document management system
2. the file name of the template which has been uploaded to the document management system
3. the file name of the template which exists in the cfg directory of your project
4. the file name of the template which exists in one of the directories listed in the following system definition:

```kotlin
// comma separated list of directories for the generator to look for the template in as per the provided file name
...
- `templateId` - see [Providing a Template](/develop/business-components/doc-generate/developer-guide/#providing-a-template)
