...
| SELF | Sends the notification to the user populated in the 'Sender' field of the notification. Example: Password reset notifications. ENTITY_ID is optional for this type — see below for how it changes the behaviour. |
