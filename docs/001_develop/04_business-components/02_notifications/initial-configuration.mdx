...
The best way to add the Notifications component to a new application is to use GenX - see [GenX CLI](/develop/development-environment/genx/) for more details.
