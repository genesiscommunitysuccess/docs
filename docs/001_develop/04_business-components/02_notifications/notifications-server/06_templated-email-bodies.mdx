...
After you have created the HTML template and any embedded image files, load these to `FILE_STORAGE`. (Behind the scenes, the email builder uses the [Document Generation](../../../generated-docs/generated-docs-server) to create the email bodies.) Once the files are in the correct location, you can use them to generate your email bodies.
...
There are examples of how to structure the data in your HTML templates in our [Document Generation](/develop/business-components/generated-docs/generated-docs-server/#html-templates) pages. 
