...
There are some pipeline implementations provided with the Notifications component that can be used within any data pipeline you have set up. See [Data Pipelines](/server/data-pipelines/introduction/) for more information.
