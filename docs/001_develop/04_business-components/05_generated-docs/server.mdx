...
If you need any other assets to produce the results you need in the template (images, css files etc.), you must also upload these. Along with this, the must be a `TEMPLATE_ASSET` record that maps these assets to the template.
