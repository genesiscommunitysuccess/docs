...
In order to source FIX messages for your pipeline, you must have the following packages in the [process definition](/develop/server-capabilities/runtime-configuration/processes/) where your pipeline is located:
...
In order to send fix messages to a session from your pipeline, you must have the following packages in the process definition of where your pipeline is located:
...
See [process configuration](/develop/server-capabilities/runtime-configuration/processes/) for more information about process definitions.
