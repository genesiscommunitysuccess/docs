...
Internationalization is the requirement for making your application suitable for users in different cultures, taking into account language, legal requirements and such important minutiae as the different formats of symbols, telephone numbers and postal codes. Processes for dealing with these issues are referred to under the spectacularly unhelpful acronym [i18n](https://www.w3.org/International/i18n-drafts/nav/about).

The `@genesislcap/foundation-i18n` package provides a collection of services and utilities based on the [i18next](https://www.i18next.com/) framework. These provide important internationalization features for your application:
