...
export function MyExampleComponent() {
  const translateWords = () => {
    console.log(i18nService.translate('Home'));
    console.log(i18nService.translate('Admin'));
    console.log(i18nService.translate('Reporting'));
    console.log(i18nService.translate('Notifications'));
    console.log(i18nService.translate('Features Lab'));
  };

  return (
    <>
      <rapid-button onClick={() => i18nService.addResources?.()}>
        Add Translation Resources
      </rapid-button>
      <rapid-button onClick={() => i18nService.switchLanguage()}>
        Switch between PT and EN
      </rapid-button>
      <rapid-button onClick={translateWords}>
        Translate i18n Resource Words
      </rapid-button>
    </>
  );
}
...
See the [React example](#react-example) below for a full `i18nService` setup.
...
@Component({
  ...
  template: `
    <rapid-button (click)="addResources()">Add Translation Resources</rapid-button>
    <rapid-button (click)="switchLanguage()">Switch between PT and EN</rapid-button>
    <rapid-button (click)="translateWords()">Translate i18n Resource Words</rapid-button>
  `,
  standalone: true,
})
export class MyExampleComponent {
  ...
  translateWords() {
    console.log(this.i18n.translate('Home'));
    console.log(this.i18n.translate('Admin'));
    console.log(this.i18n.translate('Reporting'));
    console.log(this.i18n.translate('Notifications'));
    console.log(this.i18n.translate('Features Lab'));
  }
}
```

See the [Angular example](#angular-example) below for a full `I18nService` setup.
