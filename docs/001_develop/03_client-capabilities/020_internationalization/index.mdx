...
sidebar_position: 20
pagination_next: develop/client-capabilities/desktop-interoperability/client-desktop-interoperablity
---
...
For more detailed information on API and configurations, please refer to the [API documentation](./01_internationalization-docs/docs/api/index.md) in the `docs/api` directory.
