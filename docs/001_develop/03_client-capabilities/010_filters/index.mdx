...
* **userAgent**<!-- TODO: [userAgent](./docs/api/foundation-filters.useragentfilter.md) -->: It filters content based on user's browser, OS, devices or specified user agent string. It allows customized expereince according to specific environments, such as targetting mobile devices audience or restricting access on a particular browser.
