...
You can also pass custom language options by providing an attribute with this data. Here is an example of how to set up the foudnation-header component with the show-language-selector attribute and custom language options:
