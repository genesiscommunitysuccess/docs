...
To use the values in the store, you need to bind the properties of the getter inside your components. There are various ways to this, which are covered in this section.
