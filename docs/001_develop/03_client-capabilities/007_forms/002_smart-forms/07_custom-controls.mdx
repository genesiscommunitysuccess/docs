...
You need to create a custom renderer template to render your new form control. This example creates a control that renders options using the [Segmented Control](/web/web-components/form/segmented-control/?_highlight=segment) element.
