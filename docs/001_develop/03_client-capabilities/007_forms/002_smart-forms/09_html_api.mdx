...
|confirmation-message|`string`|If set, this message will pop up in a confirmation dialog when the user attempts to submit the form.|`<foundation-form confirmation-message="Are you sure want to submit this form? This action cannot be undone.">`|
