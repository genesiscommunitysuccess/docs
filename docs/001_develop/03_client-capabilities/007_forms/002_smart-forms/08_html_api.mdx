...
|uischema	|`UiSchema`|UI schema used to define configuration of the layout and elements in the form. Check [UiSchema](/web/forms/docs/api/foundation-forms.uischema/) for possible options.|`<foundation-form :uischema=${(x) => x.uischema}>`|
