...
|uischema	|`UiSchema`|UI schema used to define configuration of the layout and elements in the form. Check [UiSchema](Check [UiSchema](./docs/api/foundation-forms.uischema.md) for possible options.|`<foundation-form :uischema=${(x) => x.uischema}>`|
