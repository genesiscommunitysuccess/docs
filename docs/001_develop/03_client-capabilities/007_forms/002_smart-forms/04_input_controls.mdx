...
If you want to compose the option label from multiple fields returned by `ALL_COUNTERPARTIES`, use the `rowDataMapper` attribute. It lets you project new properties on every row before the renderer consumes the data.
