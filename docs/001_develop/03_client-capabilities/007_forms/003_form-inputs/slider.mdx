...
```html
<Slider>
  <SliderLabel position="0"> Low </SliderLabel>
  <SliderLabel position="50"> Mid </SliderLabel>
  <SliderLabel position="100"> High </SliderLabel>
</Slider>
```

    Usage
    ```tsx
import { Slider, SliderLabel } from '@genesislcap/rapid-design-system/react';
...
export function MyComponent() {
      ...
      return (
        <div>
            <label>Simple slider</label>
            <Slider onChange={handleSliderChanged}></Slider>
        </div>
        <div>
            <label>Slider with labels and step value of 1</label>
            <Slider
