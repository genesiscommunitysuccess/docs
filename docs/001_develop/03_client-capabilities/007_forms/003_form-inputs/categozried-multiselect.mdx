...
```
  ...
  Declaration
```html
<CategorizedMultiselect></CategorizedMultiselect>
```
  Usage
```tsx
import { CategorizedMultiselect } from '@genesislcap/rapid-design-system/react';
...
export function MyComponent() {
  ...
  return (
    <CategorizedMultiselect options={options} onselectionChange={selectionChange} selectedOptions={selectedOptions}>
