...
```html
<Stepper>
  <StepperTab>Step 1</StepperTab>
  <StepperTab>Step 2</StepperTab>
  <StepperTab>Step 3</StepperTab>
  <StepperTabPanel>
      Tab Panel 1
  </StepperTabPanel>
  <StepperTabPanel>
...
```
    Usage
    ```tsx
import { Stepper, StepperTab, StepperTabPanel } from '@genesislcap/rapid-design-system/react';
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Hides the stepper tabs (navigation tabs) completely</td>
            <td>
              ```typescript
              <rapid-stepper hide-tabs>
              ```
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><code>boolean</code></td>
            <td>Allows users to click on future steps to navigate forwards (with validation). If there are validation error(s) on step(s) between your current and selected step, the stepper will jump as many steps as possible until the first step with validation errors.</td>
            <td>
              ```typescript
  ...
  return (
    ...
    >
      ...
      <StepperTabPanel>
        ...
        >
          <ListboxOption>123</ListboxOption>
          <ListboxOption>abc</ListboxOption>
        </Select>
      </StepperTabPanel>
      <StepperTabPanel>
        <TextField
...
import type { StepperRef } from '@genesislcap/rapid-design-system/react';
  ...
  return (
    <>
      <Stepper ref={stepperRef}>
        ...
        <StepperTab>Step 2</StepperTab>
        <StepperTab>Step 3</StepperTab>
        <StepperTabPanel>Content 1</StepperTabPanel>
        <StepperTabPanel>Content 2</StepperTabPanel>
        <StepperTabPanel>Content 3</StepperTabPanel>
      </Stepper>

      <Button onClick={goToFirst}>Go to First</Button>
      <Button onClick={goToLast}>Go to Last</Button>
      <Button onClick={goToSpecific}>Go to Step 2</Button>
    </>
  );
}
```
