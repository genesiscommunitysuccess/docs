...
keywords: [presentation, badge, personalization, personalisation,user, image]
tags:
- presentation
- badge
- personalization
...
```
  Usage
  ```tsx
import { Badge } from '@genesislcap/rapid-design-system/react';

export function MyComponent() {
    return (
      <Badge fill="primary" color="light">JD</Badge>
    );
  }
  ```
</TabItem>
