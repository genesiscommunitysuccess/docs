...
Directives in Genesis Elements are special functions used in the templates in order to add specific functionality. This section looks at the most commonly used directives:
