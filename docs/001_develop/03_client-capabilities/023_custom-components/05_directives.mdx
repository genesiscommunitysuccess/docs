...
Directives in Genesis Elements are special attributes or decorators that add specific functionality to the template or component logic. Below is a summary of commonly used directives:
