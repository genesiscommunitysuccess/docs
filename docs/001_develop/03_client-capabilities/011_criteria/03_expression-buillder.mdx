...
The Expression Builder includes special operators for working with date fields:

- `IS_CURRENT`: Checks if a date field matches the current time period (hour/day/week/month/year)
...
The time period values supported are:
- `HOUR`
- `DAY`
- `WEEK`
- `MONTH`
