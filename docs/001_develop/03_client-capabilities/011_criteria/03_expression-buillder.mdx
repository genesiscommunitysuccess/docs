...
:::warning
This page is about the utility which is used to build Grid and Chart filter criteria. For the UI input component of the same name used for defining arbitrary expressions please [see here](../../expression-builder/).
:::
