...
The `CriteriaBuilder` is a utility class designed to generate query criteria in a Groovy expression format. These criteria can be used in requests to backend services.
