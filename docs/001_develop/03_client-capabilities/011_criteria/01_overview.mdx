...
The `rapid-g2plot-chart` component can be populated with data use the `chart-datasource` component.

This example is a simple line chart which retrieves data from a **Price history**

<CollapsibleSlot title="Price history data" description="The price history table and dataserver would look like this">
