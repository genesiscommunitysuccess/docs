...
sidebar_label: 'Login'
id: client-login
keywords: [web, login, foundation login, frontend, ui, micro-front-ends, mfa, verify]
tags:
  - web
  - login
  - foundation login
...
<tr>
  <td>[showEnvironmentIndicator](./docs/api/foundation-login.loginconfig.showenvironmentindicator.md)</td>
  <td><code>boolean</code></td>
  <td>Toggles the display of the environment indicator. See [Environment Indicator](../env-files/environment-indicator) for configuration details.</td>
  <td>
    ```typescript
