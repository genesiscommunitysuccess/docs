...
The Verify page uses the [Verification Code Input](/develop/client-capabilities/forms/form-inputs/client-interaction-verification-code-input/) component for digit entry. You can omit the Verify route via [`omitRoutes`](./docs/api/foundation-auth.authconfig.omitroutes.md) if you provide an alternative MFA UI.
