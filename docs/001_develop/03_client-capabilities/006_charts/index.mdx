...
Genesis charts are based on [G2plot](https://g2plot.antv.antgroup.com/en/), a powerful charting library that provides various customizable chart types, enabling you to create interactive and visually appealing data visualizations.
...
Declaration:
```html
<G2PlotChart></G2PlotChart>
```

Usage:
```tsx
import { G2PlotChart } from '@genesislcap/g2plot-chart/react';
