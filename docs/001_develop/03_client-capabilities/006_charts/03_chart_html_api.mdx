...
```
        ...
        <tr>
            ...
            <td>Maximum number of rows to be returned as part of the initial message, and as part of any additional MORE_ROWS messages (if your data source is Data Server). This will not affect the number of rows displayed.</td>
<td>
