...
```
        ...
        <tr>
            <td>orderBy</td>
            <td><code>string</code></td>
            <td>This option can be used to select a [Data Server index](../../../server-capabilities/real-time-queries-data-server/#indices) (defined in the Data Server query), which is especially useful if you want the data to be sorted in a specific way.</td>
<td>
