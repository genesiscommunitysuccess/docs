---
title: 'Chart Declerative HTML API'
sidebar_label: 'Chart Declerative HTML'
id: chart-html-api
keywords: [genesis, foundation, ui, chart, g2plot-chart, g2plot, Attribute, Property, Template, Declerative HTML, Events, DOM API, datasource]
tags:
  - connected
  - datasource
  - chart
...
Declarative HTML API enables developers to create and configure charts directly in HTML using simple, semantic tags. It streamlines the charting process by embedding data and configuration options within HTML elements, avoiding complex JavaScript code. 
...
| Slot | Use |
|---|---|
|chart-datasource-error|The `chart-datasource-error` slot is displayed when the data source encounters errors, such as connection issues or invalid data. This slot allows developers to define custom fallback content or error messages for a better user experience.|
...
import GrovyFilterExpressions from '../../../../_includes/_groovy-filter-expressions.mdx'
