...
The `foundation-environment-indicator` component displays an environment badge with customizable styling and behavior. It supports:
...
```html
<foundation-environment-indicator></foundation-environment-indicator>
```

### With Custom Attributes

```html
<foundation-environment-indicator
  level="dev"
  label="DEVELOPMENT"
...
```css
foundation-environment-indicator::part(environment-indicator) {
