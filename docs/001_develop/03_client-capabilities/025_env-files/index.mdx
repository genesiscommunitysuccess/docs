...
@Component({
  ...
  template: `
    <div class="container">
      ...
      <div *ngIf="analyticsEnabled" class="analytics-section"><!-- ... --></div>
    </div>
  `,
  standalone: true,
})
export class ExampleComponent {
  analyticsEnabled = GENX_ANALYTICS_ENABLED === 'true';
}
```
...
- [Multiple Dot Env Files](./multiple-dot-env-files) - Learn how to include multiple dot env files for complex environment configurations
