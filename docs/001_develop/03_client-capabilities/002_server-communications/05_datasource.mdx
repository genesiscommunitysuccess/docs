...
sidebar_label: 'Datasource Integration'
id: comms-datasource
...
This provides a framework for interacting with different types of data sources within the application. It abstracts the complexities of fetching, streaming, and manipulating data from various back-end services.
