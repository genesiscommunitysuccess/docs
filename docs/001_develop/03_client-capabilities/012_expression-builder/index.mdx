...
:::warning
These pages about the Expression Builder which is a UI component for building any types of expressions. For the utility of the same name which is used to build Grid and Chart filter criteria please [see here](/develop/client-capabilities/criteria/expression-builder/).
:::
