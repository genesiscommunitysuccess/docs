...
:::tip
This component is based on the [expression builder library](..) and is pre-configured to create transformation expressions that the back-end can work with. If you want to set your own operations and other configurations you can create your own component using the base library.
:::
