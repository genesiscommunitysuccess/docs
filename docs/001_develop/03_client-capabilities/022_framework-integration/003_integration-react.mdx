...
- **foundation-login.ts**. This configures the `@genesislcap/foundation-auth` micro front-end component that handles authorisation and integrates it with the routing system.
