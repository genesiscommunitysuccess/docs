...
@Component({
  selector: 'entity-management-filters',
  template: `
    <entity-management
      design-system-prefix="rapid"
      resourceName="ALL_COUNTERPARTYS"
...
export class EntityManagementFiltersComponent {}
```
...
export class EntityManagementFiltersComponent {
  counterpartyFiltersUIschema = counterpartyFiltersUIschema;
}
```
