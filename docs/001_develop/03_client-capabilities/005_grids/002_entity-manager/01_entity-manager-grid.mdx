...
export function EntityManagementColumns() {
  return (
    <EntityManagement
      prefix="rapid"
...
@Component({
  selector: 'entity-management-columns',
  template: `
    <entity-management
      design-system-prefix="rapid"
      resourceName="ALL_COUNTERPARTYS"
...
export class EntityManagementColumnsComponent {
...
export function EntityManagementCrudTopExample() {
  return (
    <EntityManagement
      prefix="rapid"
      crudMenuPosition="top"
      resourceName="ALL_COUNTERPARTYS"
      ...
      createEvent="EVENT_COUNTERPARTY_INSERT"
    >
      <Button slot="crud-top-before">Custom before</Button>
      <Button slot="crud-top-after">Custom after</Button>
    </EntityManagement>
  );
}
```
...
@Component({
  selector: 'entity-management-crud-top-example',
  template: `
    <entity-management
      design-system-prefix="rapid"
      crud-menu-position="top"
...
export class EntityManagementCrudTopExampleComponent {}
```
...
export function EntityManagementCrudBottomExample() {
  return (
    <EntityManagement
      prefix="rapid"
      crudMenuPosition="bottom"
      resourceName="ALL_COUNTERPARTYS"
      title="Custom buttons"
      updateEvent="EVENT_COUNTERPARTY_MODIFY"
      deleteEvent="EVENT_COUNTERPARTY_DELETE"
      createEvent="EVENT_COUNTERPARTY_INSERT"
    >
      <Button slot="crud-bottom-before">Custom before</Button>
      <Button slot="crud-bottom-after">Custom after</Button>
    </EntityManagement>
  );
}
```
...
@Component({
  selector: 'entity-management-crud-bottom-example',
  template: `
    <entity-management
      design-system-prefix="rapid"
      crud-menu-position="bottom"
...
export class EntityManagementCrudBottomExampleComponent {}
```
...
You can enable `.csv` file exports on any entity manager component via its properties. To enable this feature with the default values you configure the property with a function that returns an empty object.
...
export function EntityManagementCsvExportExample() {
  return (
    <EntityManagement
      prefix="rapid"
      resourceName="ALL_COUNTERPARTYS"
...
@Component({
  selector: 'entity-management-csv-export-example',
  template: `
    <entity-management
      design-system-prefix="rapid"
      resourceName="ALL_COUNTERPARTYS"
      title="Counterparty Management"
      createEvent="EVENT_COUNTERPARTY_INSERT"
      [enableCsvExport]="csvExportConfig"
    />
  `,
  standalone: true,
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
})
export class EntityManagementCsvExportExampleComponent {
  csvExportConfig = () => ({});
}
```
...
The reason for returning an object is you can choose to configure that object to override the default values. For example:
...
export function EntityManagementCsvExportCustomExample() {
  return (
    <EntityManagement
      prefix="rapid"
      resourceName="ALL_COUNTERPARTYS"
...
@Component({
  selector: 'entity-management-csv-export-custom-example',
  template: `
    <entity-management
      design-system-prefix="rapid"
      resourceName="ALL_COUNTERPARTYS"
...
export class EntityManagementCsvExportCustomExampleComponent {
  csvExportConfig = () => ({
    buttonName: 'Download',
    fileName: 'counterparty-export',
  });
...
The default button name is `Export` and the filename is `export.csv`. Once the feature is enables a button will be shown on the entity manager which will download the `.csv` file of the data when clicked.
