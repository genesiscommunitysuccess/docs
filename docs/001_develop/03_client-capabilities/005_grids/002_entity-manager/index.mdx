...
:::info
For a full list of attributes and properties with examples, see the [Entity Manager declarative HTML](./04_entity-manager-api.mdx) or [API documents](./docs/api/foundation-entity-management.md).
:::
