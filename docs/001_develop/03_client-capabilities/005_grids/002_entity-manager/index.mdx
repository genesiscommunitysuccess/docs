...
:::info
For a full list of attributes and properties, see the [Entity Manager declarative HTML](./03_entity-manager-api.mdx) or [API documents](./docs/api/foundation-entity-management.md).
:::
