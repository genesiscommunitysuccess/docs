...
- **Row alerts**: Sustained flashing of rows that match declarative criteria, optionally paired with tab alerts and a presets context menu. See [Row alerts](/develop/client-capabilities/grids/grid-pro/grid-pro-row-alerts).
