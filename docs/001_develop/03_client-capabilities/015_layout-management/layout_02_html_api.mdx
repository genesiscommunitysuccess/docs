...
:::warning
This layout module (`rapid-layout`) is intended for **web-components (Genesis) projects only**. For new **React** projects, use [FlexLayout](https://www.npmjs.com/package/flexlayout-react) (`flexlayout-react`) instead.
:::
