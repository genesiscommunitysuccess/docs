...
```
    ...
    <tr>
      <td>registration</td>
      <td><code>string</code></td>
      <td>Sets the registered name of the component. Not required to be set unless you're also using the javascript API. See here. <!-- TODO -->. By default each item that doesn't have a registration is registered sequentially starting at <code>"1"</code>.</td>
<td>
