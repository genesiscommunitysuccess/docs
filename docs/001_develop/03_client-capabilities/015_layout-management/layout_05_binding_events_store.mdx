...
There's still got a big issue here though - `isSelected` isn't linked between them anymore! Here is adding in some formal state management is required.
