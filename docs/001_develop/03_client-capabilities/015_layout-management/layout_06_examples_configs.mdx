...
When you have enabled autosave, you are still able to use the manual serialising commands ([getLayout](../docs/api/foundation-layout.foundationlayout.getlayout/) and [loadLayout](../docs/api/foundation-layout.foundationlayout.loadlayout/)).
...
This is an example of using the JavaScript API to add items to the layout at runtime. Before reading this example, you should familiarize yourself with the [API Section](/develop/client-capabilities/layout-management/foundation-layout/#javascript-api).
