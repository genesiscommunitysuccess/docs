...
If you are only using the javascript API then you should apply the property before the items are added to the layout.
```typescript
...
See [this example](../client-layout-management-ptifalls/#observables-with-directives).
:::
