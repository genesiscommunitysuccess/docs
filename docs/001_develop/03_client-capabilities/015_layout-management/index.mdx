...
```tsx
import { Button, Checkbox, Layout, LayoutItem, LayoutRegion } from '@genesislcap/rapid-design-system/react';
...
export default function LayoutExample({ }) {
  return (
    <Layout>
      <LayoutRegion>
        <LayoutRegion type="vertical">
          <LayoutItem title="Button">
            <Button>Rapid Button</Button>
          </LayoutItem>
          <LayoutItem title="Checkbox">
            <Checkbox>Rapid Checkbox</Checkbox>
          </LayoutItem>
        </LayoutRegion>
        <LayoutItem title="Text">
          <ReactComponent />
        </LayoutItem>
      </LayoutRegion>
    </Layout>
