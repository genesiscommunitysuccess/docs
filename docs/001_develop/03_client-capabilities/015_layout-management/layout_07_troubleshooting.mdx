...
As explained in the [lifecycle info section](../client-layout-management-items/#resource-intensive-components), this component may have its `disconnectedCallback` and `connectedCallback` lifecycle at unnecessary times, effectively wasting time re-initializing a potentially heavy resource.
