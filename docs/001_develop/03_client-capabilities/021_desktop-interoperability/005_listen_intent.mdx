...
This is a utility element that listens to any raised [intents](https://fdc3.finos.org/docs/intents/spec) in FDC3 that are handled by the application.
...
:::warning Compatibilty with Desktop Agent implementations
