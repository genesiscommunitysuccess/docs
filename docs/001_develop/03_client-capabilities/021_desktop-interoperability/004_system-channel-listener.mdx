...
FDC3 channel system listener is a utility element that listens to the FDC3 [system channel (also known as a user or color channel)](https://fdc3.finos.org/docs/api/ref/Channel) for the specified context.
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>An array of objects that configure which context type and the handler for channel event payloads</td>
<td>
