...
<table>
    ...
    <tbody>
        <tr>
            <td>expanded</td>
            <td><code>boolean</code></td>
            <td>When true, the control will appear expanded by user interaction. Emits <code>expanded-change</code> event when changed.</td>
<td>
...
```
        ...
        <tr>
            <td>selected</td>
            <td><code>boolean</code></td>
            <td>When true, the control will appear selected by user interaction. Emits <code>selected-change</code> event when changed.</td>
<td>
