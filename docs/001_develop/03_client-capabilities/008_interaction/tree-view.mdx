...
```
    ...
    Usage
    ```tsx
import { TreeItem, TreeView } from '@genesislcap/rapid-design-system/react';
...
export function MyComponent() {
      return (
        <TreeView>
          ...
          <TreeItem>
            Item 1
            <TreeItem>Sub-item 1-1</TreeItem>
            <TreeItem>Sub-item 1-2</TreeItem>
            <TreeItem>
              Item 2
              <TreeItem>Sub-item 2-1</TreeItem>
              <TreeItem>Sub-item 2-2</TreeItem>
            </TreeItem>
          </TreeItem>
