...
import { Listbox, ListboxOption } from '@genesislcap/rapid-design-system/react';
...
export function MyComponent() {
    ...
    return (
      <div>
        <Listbox onClick={(e) => setSelected(e.target.value)}>
          <ListboxOption value="apple">Apple</ListboxOption>
          <ListboxOption value="banana">Banana</ListboxOption>
          <ListboxOption value="strawberry">Strawberry</ListboxOption>
        </Listbox>
