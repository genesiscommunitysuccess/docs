...
:::tip
This component is primarily used as part of other custom form components. If you simply want to use a form item which allows the user to select one value, use a [`<rapid-radio-group></rapid-radio-group>`](../../forms/form-inputs/client-interaction-radio-group) or [`<rapid-segmented-control></rapid-segmented-control>`](../../forms/form-layout/client-interaction-segmented-control/) instead.
:::
