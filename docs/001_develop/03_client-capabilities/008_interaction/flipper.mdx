...
```
    ...
    Usage
    ```tsx
import { CodeSection, Flipper } from '@genesislcap/rapid-design-system/react';
...
export function MyComponent() {
      ...
      return (
        <CodeSection>
          <Flipper onClick={() => console.log('previous')} direction="previous"></Flipper>
          <Flipper onClick={() => console.log('next')} direction="next"></Flipper>
        </CodeSection >
      )
    }
    ```
