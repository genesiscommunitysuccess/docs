...
```
    ...
    Usage
    ```tsx
import { Divider, Event, Menu, MenuItem } from '@genesislcap/rapid-design-system/react';
...
export function MyComponent() {
      ...
      return (
        <Menu onChange={(e) => handleMenuChange(e as Event & {target: MenuItem})}>
          <MenuItem onClick={itemOneAction}>Menu item 1</MenuItem>
          <MenuItem>Menu item 2</MenuItem>
          <MenuItem>Menu item 3</MenuItem>
          <Divider></Divider>
          <MenuItem role="menuitemradio">Menu item 4</MenuItem>
          <MenuItem role="menuitemradio">Menu item 5</MenuItem>
        </Menu>
      )
    }
    ```
