...
<table>
    ...
    <tbody>
        <tr>
            <td>type</td>
            <td><code>default</code> <code>alert</code> <code>error</code> <code>success</code></td>
            <td>The type of dialog, one of <code>default</code>, <code>error</code> or <code>success</code> or <code>alert</code>. <strong>Defaults to <code>default</code></strong>. This changes the background color of the modal.</td>
            <td>
        ...
        <tr>
            ...
            <td>Determines the position of the modal. <strong>Defaults to <code>center</code></strong>.</td>
            <td>
...
```
        ...
        <tr>
            ...
            <td>Sets the initial width, in pixels, of the modal when it is first opened.</td>
<td>
...
```
        ...
        <tr>
            ...
            <td><code>number</code></td>
            <td>Sets the initial height, in pixels, of the modal when it is first opened.</td>
<td>
...
```
        ...
        <tr>
            <td>min-width</td>
            <td><code>number</code></td>
            <td>Sets the minimum width, in pixels, that the modal can be resized to. Only applies when <code>resizable</code> is set to <code>true</code>.</td>
<td>
...
```
        ...
        <tr>
            <td>min-height</td>
            <td><code>number</code></td>
            <td>Sets the minimum height, in pixels, that the modal can be resized to. Only applies when <code>resizable</code> is set to <code>true</code>.</td>
<td>
