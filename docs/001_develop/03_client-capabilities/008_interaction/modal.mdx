...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>The type of dialog one of <code>default</code>, <code>alert</code> or <code>success</code>. <strong>Defaults to <code>default</code></strong>. This changes the styling depending on value.</td>
            <td>
        ...
        <tr>
            <td>position</td>
            <td><code>string</code></td>
            <td>Determines the position of the modal. Possible options are <code>center</code>, <code>left</code>, or <code>right</code>. <strong>Defaults to <code>center</code></strong>.</td>
            <td>
        ...
        <tr>
            <td>resizable</td>
            <td><code>boolean</code></td>
            <td>Enables resizing the modal. Defaults to 'false'.</td>
            <td>
        ...
        <tr>
            <td>initialWidth</td>
            <td><code>string</code></td>
            <td>Sets the initial width of the modal when it is first opened. Accepts CSS width values (e.g., '500px', '50%', '30rem').</td>
            <td>

            ```typescript
            <rapid-modal initialWidth="500px">
            ```
        ...
        <tr>
            <td>initialHeight</td>
            <td><code>string</code></td>
            <td>Sets the initial height of the modal when it is first opened. Accepts CSS height values (e.g., '400px', '50vh', '30rem').</td>
            <td>

            ```typescript
            <rapid-modal initialHeight="400px">
            ```
        ...
        <tr>
            <td>minWidth</td>
            <td><code>string</code></td>
            <td>Sets the minimum width that the modal can be resized to. Accepts CSS width values (e.g., '300px', '20%', '20rem'). Only applies when <code>resizable</code> is set to <code>true</code>.</td>
            <td>

            ```typescript
            <rapid-modal resizable="true" minWidth="300px">
            ```
        ...
        <tr>
            <td>minHeight</td>
            <td><code>string</code></td>
            <td>Sets the minimum height that the modal can be resized to. Accepts CSS height values (e.g., '200px', '20vh', '20rem'). Only applies when <code>resizable</code> is set to <code>true</code>.</td>
            <td>

            ```typescript
            <rapid-modal resizable="true" minHeight="200px">
            ```
...
|--|--|--|--|
| close | `void` | Fired when the dialog is closed, either through the close button, escape key, or programmatic close. | `<rapid-modal @close="${(x) => x.handleDialogClose()}">` |
