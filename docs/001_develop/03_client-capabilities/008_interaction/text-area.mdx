...
```
    ...
    <tr>
      <td>resize</td>
      <td><code>string</code></td>
      <td>Allows the user to resize the element; this can be {"none","both","vertical","horizontal"}. **Default: none**</td>
<td>
...
```
    ...
    <tr>
      <td>value</td>
      <td><code>string</code></td>
      <td>The text area content</td>
<td>

```typescript
<text-area value="Text area value">
```
