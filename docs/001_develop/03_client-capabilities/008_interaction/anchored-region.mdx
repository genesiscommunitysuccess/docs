...
```
        ...
        <tr>
            ...
            <td><code>boolean</code></td>
            <td>Controls whether the region must remain in the `viewport` on the vertical axis (i.e. detatches from the anchor). Default: false</td>
<td>
...
```
        ...
        <tr>
            ...
            <td><code>boolean</code></td>
            <td>WControls whether the region can overlap the anchor on the vertical axis</td>
<td>
