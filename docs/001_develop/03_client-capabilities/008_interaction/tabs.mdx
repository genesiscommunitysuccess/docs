...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>The orientation of the tabs menu. <em>Default: "horizontal"</em>.</td>
<td>
...
```
        ...
        <tr>
            ...
            <td>Whether or not to show the active indicator on the active tab. <em>Default: <code>true</code></em></td>
<td>
...
|tabpanel|The slot for tabpanels ([`<rapid-tab-panel>`](#tab-panel-api))|
