...
```
    ...
    Usage
    ```tsx
import { CodeSection, DropdownMenu } from '@genesislcap/rapid-design-system/react';
...
export function MyComponent() {
      ...
      return (
        <CodeSection>
          <DropdownMenu items={setOfItems}></DropdownMenu>
        </CodeSection>
      )
    }
    ```
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>Controls whether the dropdown closes automatically  (Default: true)</td>
<td>
...
<table>
    ...
    <tbody>
        <tr>
            <td>items</td>
            <td><code>DropdownMenuItem[]</code></td>
            <td>Configure the items to be in the dropdown menu.</td>
<td>
