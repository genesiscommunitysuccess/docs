...
|Slot|Description|
|---|---|
|Default|The text which appears on the root dropdown menu button.|

### Parts

|Part|Description|
|---|---|
|`actions-container`|The main container element which wraps up the button and the dropdown menu.|
|`actions-opener`|The button which opens the dropdown.|
