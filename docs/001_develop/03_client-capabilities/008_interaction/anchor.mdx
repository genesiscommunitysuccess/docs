...
```
    ...
    Usage
    ```tsx
import { Anchor } from '@genesislcap/rapid-design-system/react';

export function MyComponent() {
      return (
        <Anchor href="https://genesis.global/">External link</Anchor>
        <Anchor href="#api">Internal link</Anchor>
        <Anchor href="mailto:info@genesis.global">Mail link</Anchor>
      );
    }
    ```
  </TabItem>
