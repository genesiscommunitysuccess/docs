...
You can use `rapid-section-navigator` or `zero-section-navigator` depending on your design system.
...
<rapid-section-navigator>
  <div slot="section1">
    <h2>Section 1 Content</h2>
    <button onclick="handleSetActive(event)">
      Set Active State
    </button>
  </div>
</rapid-section-navigator>

function handleSetActive(event) {
  const button = event.target;
  const setStateEvent = new CustomEvent('section-navigator-set-state', {
    detail: { stateName: 'active' },
    bubbles: true
  });
  button.dispatchEvent(setStateEvent);
...
<rapid-section-navigator>
  <div slot="section1">
    <h2>Section 1 Content</h2>
    <button onclick="handleSetMultipleStates(event)">
      Add Multiple States
    </button>
  </div>
</rapid-section-navigator>

function handleSetMultipleStates(event) {
  const button = event.target;
  const setStatesEvent = new CustomEvent('section-navigator-set-states', {
    detail: { stateNames: ['active', 'pending'] },
    bubbles: true
  });
  button.dispatchEvent(setStatesEvent);
  // Component auto-detects 'section1' from slot context
}
```
</td>
...
<rapid-section-navigator>
  <div slot="section1">
    <h2>Section 1 Content</h2>
    <button onclick="handleClearState(event)">
      Clear Active State
    </button>
  </div>
</rapid-section-navigator>

function handleClearState(event) {
  const button = event.target;
  const clearStateEvent = new CustomEvent('section-navigator-clear-state', {
    detail: { stateName: 'active' },
    bubbles: true
  });
  button.dispatchEvent(clearStateEvent);
  // Component auto-detects 'section1' from slot context
}
```
</td>
...
<rapid-section-navigator>
  <div slot="section1">
    <h2>Section 1 Content</h2>
    <button onclick="handleClearAllStates(event)">
      Clear All States
    </button>
  </div>
</rapid-section-navigator>

function handleClearAllStates(event) {
  const button = event.target;
  const clearAllEvent = new CustomEvent('section-navigator-clear-all-states', {
    detail: {},
    bubbles: true
  });
  button.dispatchEvent(clearAllEvent);
  // Component auto-detects 'section1' from slot context
}
```
</td>
