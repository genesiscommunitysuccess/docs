...
export function MyComponent() {
  ...
  return (
    <rapid-checkbox onChange={handleCheckboxChange}>Checkbox</rapid-checkbox>
  );
}
```
</TabItem>
...
```
  ...
  <tr>
    <td>disabled</td>
    <td><code>boolean</code></td>
    <td>Same functionality as <code>readonly</code>, and additionally adds visual opacity to the component.</td>
<td>
