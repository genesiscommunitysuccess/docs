...
Implementation of a [select](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/select) component.
...
<Tabs defaultValue="genesis" values={[{ label: 'Genesis', value: 'genesis', }, { label: 'React', value: 'react', }, { label: 'Angular', value: 'angular', }]}>
  ...
  export function MyComponent() {
    ...
    return (
      <rapid-select onClick={handleSelectChanged}></rapid-select>
    );
  }
  ```
</TabItem>
  ...
  <rapid-select>
    ...
    <rapid-option>Option 2</rapid-option>
  </rapid-select>
  ```
