  ...
  <TabItem value="genesis">
    ...
    ```typescript
      ...
      export class MyElement extends GenesisElement {
        var criteriaFilter: string;
        var toolbarOptions: CriteriaSegmentedControlOption[] = [
...
Further details on criteria matching can be found [here](https://learn.genesis.global/docs/web/basics/criteria-matching/)
