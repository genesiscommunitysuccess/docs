...
sidebar_label: 'Typography tokens'
id: styling-tokens-typography
...
<!-- You can adjust any of the defaults in the `src/_config/values` folder of your design system. TODO: I don't think this is correct anymore -->
...
```ts
import {bodyFont} from '@genesislcap/rapid-design-system';
...
```ts
import {typeRampMinus1FontSize, typeRampMinus1LineHeight} from '@genesislcap/rapid-design-system';
