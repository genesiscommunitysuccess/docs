...
:::tip
To help you visualise how modifying tokens impacts the component look and feel, we have created a [live configuration preview](../../direct-customization-genesis-components/styling-direct-dsc/).
:::
