---
title: 'Color tokens'
sidebar_label: 'Color tokens'
id: styling-tokens-color
...
* set up colour theming through palette tinting
...
You don't have to follow the steps in this exact order. For example, you could set set dark/light mode first if you prefer.

:::tip
To help you visualize how modifying tokens impacts the component look and feel, we have created a [live configuration preview](../../direct-customization-genesis-components/styling-direct-dsc/).
:::
...
This is the most common variable, used for plain text or icons.
...
This is commonly used for link text or icon. It is also used for smaller elements that might not show up well using `accentFill`; for instance, use it if your accent colour is dark purple and you support a dark mode interface.
...
A special layer for floating layers, such as flyouts or menus. It will be lighter than any other layers if possible, but will also be white in default light mode, as will neutral layer one.
