...
:::tip
By default this will configure the `rapid` design system, which is the default. It can additionally be used to configure design
systems you define yourself too, as long as they use the same tokens.
:::
