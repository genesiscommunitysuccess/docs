...
An additional advantage of this approach is that it's component library agnostic - you can use this approach when using Genesis syntax, as well as libraries like [React](../../022_framework-integration/003_integration-react.mdx) and [Angular](../../022_framework-integration/002_integration-angular.mdx). The code examples in this section will be shown as pure `html` and `css`, and then you can apply it to whichever component library you're using.
