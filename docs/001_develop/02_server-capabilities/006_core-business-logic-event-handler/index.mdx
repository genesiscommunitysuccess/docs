...
The `triggerRemote` method can be used to call on an event from another Event Handler script file (including those in another microservice). It takes the following parameters:
