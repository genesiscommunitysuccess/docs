...
You can use the `triggerRemote` method to call an event that is not defined in this script file. This can be an event defined in the platform, or a business component that you have added to the project. `triggerRemote` takes the following parameters:
