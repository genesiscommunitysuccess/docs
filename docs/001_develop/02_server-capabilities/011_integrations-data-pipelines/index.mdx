...
<Tabs defaultValue="kotlin" values={[{ label: 'Kotlin', value: 'kotlin', }, { label: 'Java', value: 'java', }]}>
    ...
    <TabItem value="java">
      ```java
      public interface RxSource<T> extends Stoppable {
        @NotNull
        Flowable<T> read();
      }
      ```
...
<Tabs defaultValue="kotlin" values={[{ label: 'Kotlin', value: 'kotlin', }, { label: 'Java', value: 'java', }]}>
    <TabItem value="kotlin">
        ...
        ```kotlin
        class MyCustomSource<INPUT> : Source<INPUT> {
    ...
    <TabItem value="java">
        ...
        ```java
        public class MyCustomSource<T> implements RxSource<T> {

          @NotNull
          @Override
          public Flowable<T> read() {
              // your logic here
          }
...
<Tabs defaultValue="kotlin" values={[{ label: 'Kotlin', value: 'kotlin', }, { label: 'Java', value: 'java', }]}>
    <TabItem value="kotlin">
        ...
        ```kotlin
        class MyCustomBatchSource<INPUT> : BatchSource<INPUT> {
    ...
    <TabItem value="java">
        ...
        ```java
        public class MyCustomBatchSource<T> implements RxBatchSource<T> {
            @NotNull
            @Override
            public Flowable<T> execute(@NotNull Map<String, ?> inputs) {
                // your logic here
...
<Tabs defaultValue="kotlin" values={[{ label: 'Kotlin', value: 'kotlin', }, { label: 'Java', value: 'java', }]}>
    <TabItem value="kotlin">
        ```kotlin
        class MyCustomTypedBatchSource<REQUEST, INPUT> : TypedBatchSource<REQUEST, INPUT> {
