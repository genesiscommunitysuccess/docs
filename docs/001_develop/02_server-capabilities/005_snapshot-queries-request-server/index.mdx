...
| supportLazyPredicates            | Supports lazy criteria in criteria mode                   |
| timeoutInSeconds                 | timeout in seconds                                        |
| maxRows                          | max results in reply                                      |
| enableTypeAwareCriteriaEvaluator | enhanced criteria evaluation when not using criteria only |
