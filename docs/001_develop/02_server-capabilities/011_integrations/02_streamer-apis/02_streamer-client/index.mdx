...
- **Gradle dependency**: add `implementation(genesis("pal-streamerclient"))` to your application module's `build.gradle.kts` so `GPalStreamerClient` is on the compile classpath
