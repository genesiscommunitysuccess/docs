...
You can configure the client as a constructor parameter, passing a [Ktor HttpClient object if needed](https://ktor.io/docs/client-create-and-configure.html#engine-config). 

```kotlin
val client = GenesisHttpClient(Apache5) {
    engine {
...
You can follow the documented [examples on adding SSL](https://ktor.io/docs/client-ssl.html#configure-ssl) if required in your setup.
