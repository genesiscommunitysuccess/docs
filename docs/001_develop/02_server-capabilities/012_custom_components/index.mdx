...
The Genesis application platform allows developers to create [modules for business logic](/build-deploy-operate/build/project-structure/#adding-new-modules-to-a-project). 

## Injecting dependencies

A key part of writing custom code is injecting the objects your module or process relies on.
