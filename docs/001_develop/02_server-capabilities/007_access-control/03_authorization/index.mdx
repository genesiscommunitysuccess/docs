...
Typically levels 1 and 3 are controlled by [permission codes](#permission-codes), and level 2 is controlled by [entity access](#entity-access), however you can set up the application as per your business requirements. The following sections give an overview of the 2 layers and example use-cases.
...
See the relevant [client capabilities pages](/develop/client-capabilities/client-capabilities-overview/) for more details on how to secure them with permissions.

## Assigning users permissions

Most applications will include the [User management](/develop/business-components/user-management/user-management-introduction/) component for easily assigning rights and users to profiles. Users gain the superset of permissions that are assigned to the profiles they are a part of.
