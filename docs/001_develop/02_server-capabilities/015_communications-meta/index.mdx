---
title: 'Communications meta'
sidebar_label: 'Communications meta'
id: server-communications-meta
keywords: [communications, message, messaging, messages, meta, metadata, input]
tags:
  - communications
  - message
  - messaging
...
This section gives details around client to server and server to server communications. This includes message formats and defining message metadata in the Genesis application platform, as well as how to set up encrypted process communication.
