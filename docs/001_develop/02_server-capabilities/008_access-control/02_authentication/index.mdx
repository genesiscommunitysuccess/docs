...
:::info
Applications using Foundation Auth can use the [Verify page](/develop/client-capabilities/login/#multi-factor-authentication-mfa) and the [Verification Code Input](/develop/client-capabilities/forms/form-inputs/client-interaction-verification-code-input/) component for MFA code entry on the client.
:::
