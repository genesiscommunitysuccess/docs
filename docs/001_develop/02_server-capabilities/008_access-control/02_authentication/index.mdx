...
JWKS publication is controlled inside the `privateKeyJwt` block of an OIDC identity provider definition. You need to set public key and set `useJwksUrl` flag to true
