...
- `sso:` 
    - `toggled: true` - This ensures that the `Enable SSO` checkbox displayed on the application's login page **will be** checked by default. Where set to `false`, the checkbox **will not be** be checked by default.
