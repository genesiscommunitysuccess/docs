...
JWKS publication is controlled inside the `privateKeyJwt` block of an OIDC identity provider definition. You need to set public key and `useJwksUrl` flag to set to true by default
...
identityProvider("my-idp") {
    ...
    client {
        ...
        privateKeyJwt {
            ...
            useJwksUrl       = true                                      // Set by default
        }
    }
    // ...
}
