...
keywords: [communications, message, messaging, messages, meta, metdata, input]
tags:
  - communications
  - message
  - messaging
...
This section gives an overview of the message formats and defining message metadata in the Genesis application platform. 
