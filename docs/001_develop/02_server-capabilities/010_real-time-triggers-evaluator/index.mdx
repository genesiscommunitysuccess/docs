...
Rules are managed via the API, which exposes CRUD operations for maintaining the table. The tables in [Configuration Options](#configuration-options) specifies the specification of the event and query fields.
