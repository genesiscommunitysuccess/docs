...
Only valid for fields of type `STRING` fields, either  or `uuid` can be set.

`field("TRADE_ID", STRING).sequence("TR")`

In this example, in an application which has system definition `Location` set to `NY`, will generated values 000000000000001TRNY1, then 000000000000002TRNY1, and so on...
