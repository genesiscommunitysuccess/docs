...
| setDirectNull | `fun setDirectNull(property: String, value: Any?, defaultValue: Any)` | Shorthand method to set a field that can be multiple sets deep, and whcih accepts a default value for null parameters. For example, `genesisSet.setDirectNull("DETAILS.TRADE.MARKET.NAME", "Test", "Example")`. |
