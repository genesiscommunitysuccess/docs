...
There are examples of how to retrieve properties from an application's system definition in our page on [dependency injection](/develop/server-capabilities/custom_components/#injectable-properties-from-system-definition) in the API section.
