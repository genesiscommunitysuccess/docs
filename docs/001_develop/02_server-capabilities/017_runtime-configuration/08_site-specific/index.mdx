...
:::tip
These files can change from over time with new platform releases. Any Genesis platform-provided files placed in this location might need to be updated with any new platform features that your application needs to take advantage of.
:::
