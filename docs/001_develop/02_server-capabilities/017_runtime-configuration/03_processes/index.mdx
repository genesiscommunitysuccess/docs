...
id: server-processes
keywords: [server, configuration, config, processes, services, micro]
tags:
  - server
  - configuration
  - config
...
It is created automatically when you start a new Genesis project using [Genesis Create](/develop/development-environment/launchpad/create) or the [GenX CLI tool](/develop/development-environment/genx/), but you might well want to update it - and you certainly want to take a good look at it.
...
| config          | If the process has [a `process-config.kts` file](/develop/server-capabilities/runtime-configuration/process-cache/), you must specify it using this tag.                                                                                                                                                                                                                                                                                                              | No       | None             |
