...
The same files apply to an integration test, so you can run a process with TLS end to end. See
[Running a process with TLS](/develop/server-capabilities/testing-api/#running-a-process-with-tls).
