...
**Live stream cost:** A live stream keeps a continuous connection and pushes every change to every subscribed screen. It uses **much more** server and client resource than refresh on a schedule. Reserve live stream for screens where stale data is genuinely unacceptable; use scheduled refresh elsewhere.
