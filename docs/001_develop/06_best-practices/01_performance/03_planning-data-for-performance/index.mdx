...
| “Instant updates everywhere” | Live subscriptions cost more than snapshot refresh | Live only where stakeholders feel stale data; snapshot refresh (Reload/Search) elsewhere |
