...
If you want to use Genesis's Spring integration, the [Spring integration getting-started tutorial](/develop/server-capabilities/spring-integration/getting-started) walks through adding a `<project-name>-spring` module to this layout from Step 2 onward.
