...
- Click on this button to open the extension settings screen. Here, you can configure the source folder path (Client Src Path`). You can also set the `OpenAI key` in the extension's settings to use `Genesis View`.
