...
Once you have done that, you can generate the code and then build and run, either in [Genesis Cloud Workspace](#opening-in-your-genesis-workspace) (which provides an IDE to work from), or by downloading and [working in your preferred IDE locally](/develop/development-environment/launchpad/running-locally).
