...
Once you have done that, you can generate the code and then build and run, either in [Genesis Cloud Workspace](/develop/development-environment/launchpad/genesis-cloud-workspace/#opening-your-app) (which provides an IDE to work from), or by downloading and [working in your preferred IDE locally](/develop/development-environment/launchpad/downloading-your-project-to-run-locally/).
...
- Go to [Genesis Launchpad](https://portal.genesis.global/launchpad) and click "Create with AI".
...
### Summary
When you reach the Summary page, you have completed the configuration of your project.  Genesis Create is now 
able to generate a complete Genesis project which you will be able to build and run in any environment with the 
required dependencies such as a JDK, Node JS and an editor of your choice.  

Genesis provides two options.  First you may generate the project and download it to run locally on your machine.  
Genesis also provides a cloud based environment pre-configured with all the tools you would need to build the project
as well as a Web Based Visual Studio Code IDE to allow you to make modifications and see the results.  

Please follow the instructions based on the path you will choose.

#### [Running Locally](/develop/development-environment/launchpad/downloading-your-project-to-run-locally/)
#### [Running on Genesis Cloud Workspace](/develop/development-environment/launchpad/genesis-cloud-workspace/)
