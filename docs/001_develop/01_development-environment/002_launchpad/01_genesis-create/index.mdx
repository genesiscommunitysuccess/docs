...
4.	The display changes and you need to click on the `Data Source` field to select where the data is coming from: 
    ...
    Once you have done this, you can see the fields (attributes) that will be displayed in the forms. The fields for the Insert form are on the left and the fields for the Modify form are on the right.
...
You can now save your project in Genesis Launchpad so that you can build and run in Genesis Cloud Workspace. 
...
2. After a few seconds, click on the newly displayed button `View in Launchpad`. This starts Launchpad and your new project is displayed under the list of `Current Projects`. From there, you can click to open the project in Cloud Workspace, where you can [build and run](/develop/development-environment/launchpad/#launch-and-run-a-project) without needing to download a development environment.
