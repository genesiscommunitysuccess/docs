...
:::tip
It is usually easier to adjust the Excel workbook before you attempt to create the data model. You might need to make several iterations before Genesis Create can create a working schema to your satisfaction.
:::
