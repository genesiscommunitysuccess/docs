...
:::tip
Genesis Create has tooltips throughout. Hover over grid titles, blue buttons and blue questions marks to see more details and handy links to documentation.
<img src="/img/001_develop/create_tooltips.gif" alt="Create Tooltips GIF" class="center-image" />
:::
