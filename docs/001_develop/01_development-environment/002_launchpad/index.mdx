...
The Genesis Launchpad enables you to create new financial applications rapidly. It provides [Genesis Create](#genesis-create), which enables you to create a project and generate the code for a working application, and the [Genesis Cloud Workspace](#genesis-cloud-workspace), where you can load your create projects and examine and edit the code, build, and run your application, all withing your browser.
...
- In the upper area, you can either start a new project from scratch, else select from a list of pre-configured [templates](#genesis-templates).
- In the lower area, your current projects are listed. You can click "Open in code" button on any of these and start working.
...
You can use the [launchpad hub](#launchpad-hub) to re-open your projects. 

Alternatively, with VSCode open, you can easily find it again the next time you want to work on it. 
