...
The Genesis Launchpad enables you to create new financial applications rapidly. It provides [Genesis Create](#genesis-create), which enables you to create a project and generate the code for a working application, and the [Genesis Cloud Workspace](#genesis-cloud-workspace), where you can load your Create projects and examine and edit the code, build, and run your application, all within your browser.
