...
When you click on `Open in Genesis Cloud Workspace` in GenesisCreate, your code is generated automatically and placed in a zip file.
VSCode opens in the Cloud Workspace.

### Unpacking and building the project
1.	Go to the menu icon at the top left of VSCode and select `File -> View -> Command Palette`. 
 
     ![Displaying the command palette](/img/genesis-launchpad/command-palette.png)

This displays a dropdown of commands in the top bar of VSCode.

2.	Select the command `Genesis:Unpack Project`. 

     ![Unpacking the project](/img/genesis-launchpad/unpack-project.png)

After a moment, this displays a list of projects, and yours should be on top. The filename is the app name you specified at the beginning, plus a date and time stamp.

3.	Click on the project to open it.

4.	When the project is open, click on the top bar of VSCode again. Select `Show and Run Commands` from the drop-down again. 

    ![Show and Run commands](/img/genesis-launchpad/show-run-commands.png)

 5. Type `Gen` in the top bar to display a list of genesis commands. Select `Genesis Build Project`.
