...
In addition to API automation, Genesis test automation framework also includes a robust set of reusable UI automation steps to test the client side of an application.
...
The UI test automation framework comprises of the following steps. Each step provides a description and includes example usage.
