...
- **Autogenerated File Protection**: AI agents are explicitly instructed NOT to update autogenerated API documentation files
...
**File Type Handling**:
- **Autogenerated Files**: AI agents are explicitly instructed NOT to update autogenerated API documentation files
