...
- If you're editing an autogenerated markdown API document, change it to exactly match the diff result
- Replace outdated API information with the new API details from the commit
- Maintain the exact structure and format of autogenerated documentation
- Update method signatures, parameters, return types, and descriptions to match the code changes

Please provide the complete updated file content that exactly reflects the changes in the commit diff.
...
- Add new sections or update existing sections as needed
